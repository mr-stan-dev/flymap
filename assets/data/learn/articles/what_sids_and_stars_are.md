# What SIDs and STARs Are

In airline flying, departures and arrivals often follow published procedures instead of making everything up in real time.
...
It is a published route used after takeoff to guide the aircraft from the airport into the wider en route system.
...
SIDs and STARs make it easier to manage large numbers of aircraft by creating known paths for:
