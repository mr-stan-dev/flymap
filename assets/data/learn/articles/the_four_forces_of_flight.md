...
It is created by the wings as air flows around them.
...
This is caused by gravity pulling the aircraft toward the Earth.

Everything adds to weight:
...
It comes from the engines, which push the airplane through the air.

This forward motion matters because the wings need moving air to create lift.
...
As the plane moves forward, the air pushes back against it.
...
These four forces always work together:

- lift versus weight
- thrust versus drag

When they are balanced, the airplane flies steadily.

If one force becomes stronger or weaker, the aircraft changes:

- more lift can make it climb
- more weight can make it descend
