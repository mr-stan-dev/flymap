...
## 🧭 1. The Number Matches the Compass Direction
...
## ↔️ 2. The Two Ends Have Different Numbers
...
- one end might be `09`
- the other end might be `27`

## ✈️ 3. The Numbers Help With Orientation
...
> compass labels painted on the airport...  
> showing which way the runway points.

## 🟢 Quick Fact

When magnetic variation changes over time, some runways are even renumbered to match their updated heading.

Runway numbers may look simple -  
but they give pilots instant directional information every time they line up to depart or land.
