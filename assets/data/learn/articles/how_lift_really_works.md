# How Lift Really Works

Lift is the force that helps an airplane rise into the sky.
...
That flow can come from:

- the airplane moving forward
...
An airplane wing is shaped to move air smoothly.

As air meets the wing:

- some flows over the top
- some flows below
- the wing turns part of that airflow downward
...
The airflow around the wing also creates:
...
The faster the plane moves, the more air flows over the wing.

That usually means:

- more lift
- easier climb
- better support for the aircraft's weight
...
- greater than weight -> the plane can climb
...
Lift is not magic and the wing is not simply "floating."
...
- the wing redirecting air downward
