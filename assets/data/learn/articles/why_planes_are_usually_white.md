# Why Planes Are Usually White

Many commercial airplanes are painted mostly white, and that is not just a style choice.
...
White paint reflects more sunlight than darker colors, which helps reduce heat buildup.
...
On a light-colored aircraft, signs of wear can be easier to notice.
...
Aircraft paint adds weight.

Simple paint schemes can help reduce:

- extra paint layers
- repainting complexity
- cost over time
