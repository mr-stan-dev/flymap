# How Airplane Lights Help at Night

Airplanes carry several different lights, and they are not all there for the same reason.
...
They help other pilots and controllers recognize:
...
Aircraft also use flashing lights such as beacons and strobes.

These help signal that:

- the aircraft is active
- engines may be running
- the plane is entering or using a runway
...
Good aircraft lighting helps reduce that difficulty by making:
...
Aircraft lights are part of how aviation stays organized after dark.
