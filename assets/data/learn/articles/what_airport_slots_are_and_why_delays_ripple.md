# What Airport Slots Are and Why Delays Ripple

“We are waiting for a slot” sounds as if the airport has misplaced a parking space.
...
When pilots say they are waiting for a slot, they may mean a tactical air traffic flow time rather than the airline's seasonal airport slot.

Suppose storms close part of the route, fog slows arrivals, a runway becomes unavailable, or an air traffic sector reaches its safe workload. Traffic managers can assign affected flights a controlled departure time or takeoff window.

The names and procedures vary by region. In Europe, this may be an air traffic flow management slot with a calculated takeoff time. In the United States, a ground delay programme can assign an expected departure clearance time to meter arrivals into a constrained airport.
...
An airliner rarely flies only once per day. After landing, the same aircraft may carry a different group of passengers to another city. Its pilots and cabin crew may continue onto other flights, and its gate may be needed by the next arrival.

A delay on the first leg can therefore shorten the next turnaround and push later departures behind schedule. Connecting passengers, baggage, catering, maintenance checks, crew duty limits, curfews, and another airport's busy period can add new constraints.
