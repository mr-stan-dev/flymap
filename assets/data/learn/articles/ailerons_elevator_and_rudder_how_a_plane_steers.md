# Ailerons, Elevator and Rudder: How a Plane Steers

An airplane does not turn by pointing its nose like a car turns its front wheels.
...
The **elevator** is the movable horizontal surface at the tail. It controls **pitch** — whether the nose moves up or down.

Changing the elevator changes the force made by the tail. That rotates the aircraft around its center of gravity, allowing it to raise or lower the nose for climbing, descending, or adjusting speed.
...
A real maneuver rarely uses just one surface.

During a turn, the aircraft may need roll input to establish the bank, pitch input to maintain the desired flight path, and a small amount of yaw control to keep everything aligned. Automatic systems can make tiny corrections too.
...
Imagine holding a model airplane at its center:
> tilt its wings for roll, tip its nose up or down for pitch, and swing its nose left or right for yaw.
