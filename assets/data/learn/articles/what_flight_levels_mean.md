# What Flight Levels Mean

When aircraft cruise high in the sky, their altitude is often described as a **flight level** instead of a simple height.
...
- Flight Level 350 means roughly 35,000 feet in the standard pressure system
...
If every aircraft used different local pressure references, altitude separation would be harder to manage.
...
During climb, crews change their altimeter settings when reaching the transition altitude or level used in that region.
...
Flight levels are a way to keep the high-altitude sky orderly and consistent.
