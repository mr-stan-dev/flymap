# Por qué las ventanillas de los aviones son redondeadas

Si miras de cerca una ventanilla de avión, notarás algo:  
no es cuadrada, sino **redondeada**.
...
Dentro de la cabina:
- el aire está presurizado para que puedas respirar con comodidad
...
Si las ventanillas tuvieran esquinas afiladas, como las de un cuadrado:

- el esfuerzo se concentraría en esas esquinas
- podrían formarse pequeñas grietas
- las grietas podrían extenderse rápidamente
...
- el esfuerzo se distribuye de forma uniforme
- no hay un único punto débil
- son mucho más resistentes bajo presión
...
- las ventanillas de los aviones pueden soportar ciclos repetidos de presión
