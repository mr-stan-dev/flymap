# Cómo crecen las tormentas eléctricas
...
- el aire cálido y húmedo cerca del suelo empieza a ascender
- al ascender, se enfría
- el vapor de agua se convierte en gotitas de nube
...
- el aire cálido sigue subiendo
- se condensa más humedad
...
A medida que la nube crece:

- fuertes corrientes ascendentes llevan las gotas de agua a mayor altura
- las gotas se combinan y se vuelven más pesadas
- la lluvia que cae crea corrientes descendentes

👉 Ahora la nube contiene tanto:
- aire ascendente (corrientes ascendentes)
- aire descendente (corrientes descendentes)
...
- las partículas chocan y acumulan carga eléctrica
- esto da lugar a los rayos
...
- el aire ascendente encuentra una capa estable
...
- turbulencia fuerte
- movimientos verticales bruscos del aire
- rayos y granizo
...
Desde arriba, las tormentas eléctricas se ven:

- como torres altas que sobresalen por encima de otras nubes
- con una parte superior plana y extendida
