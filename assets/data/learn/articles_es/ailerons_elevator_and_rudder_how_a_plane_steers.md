# Alerones, timón de profundidad y timón de dirección: cómo se dirige un avión

Un avión no gira apuntando el morro como un coche orienta sus ruedas delanteras.
...
El **timón de profundidad** es la superficie horizontal móvil de la cola. Controla el **cabeceo**, es decir, el movimiento del morro hacia arriba o hacia abajo.

Al cambiar la fuerza que genera la cola, hace girar el avión alrededor de su centro de gravedad. Así permite levantar o bajar el morro para ascender, descender o ajustar la velocidad.
...
En una maniobra real casi nunca actúa una sola superficie.

Durante un viraje puede hacer falta controlar el alabeo para fijar la inclinación, el cabeceo para mantener la trayectoria deseada y una pequeña corrección de guiñada para que todo siga alineado. Los sistemas automáticos también pueden aplicar ajustes minúsculos.
...
Imagina que sostienes una maqueta por el centro:
> inclina las alas para el alabeo, levanta o baja el morro para el cabeceo y muévelo a izquierda o derecha para la guiñada.
