# Por qué se te tapan o destapan los oídos en un vuelo

Si alguna vez has sentido presión o una sensación de “clic” o destape en los oídos durante un vuelo, no eres el único.
...
- A mayor altitud → la presión es más baja
...
Dentro del oído hay un pequeño espacio lleno de aire.

Ese espacio está conectado con la garganta por un tubo diminuto llamado **trompa de Eustaquio**.
...
A veces la presión cambia más rápido de lo que tus oídos pueden ajustarse.

Eso crea:
- sensación de bloqueo o de “oído lleno”
- una leve molestia
- audición algo reducida
...
Acciones sencillas ayudan a que los oídos se ajusten:

- tragar
- bostezar
- masticar, por ejemplo chicle
