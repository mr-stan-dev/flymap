# Por qué las nubes se forman en capas

Cuando miras por la ventanilla de un avión, puede que notes algo interesante:  
las nubes suelen aparecer en **capas distintas**, apiladas a diferentes alturas.
...
- el aire se enfría
- la humedad se condensa en pequeñas gotas o en hielo

Pero esto solo ocurre a ciertas altitudes, donde:
- la temperatura y la humedad alcanzan el equilibrio adecuado
...
- el aire ascendente se ralentiza o se detiene
...
Cada altitud puede producir tipos diferentes de nubes:

- capas bajas → nubes planas y grises
- capas medias → parches con textura
- capas altas → nubes finas y heladas
...
- una manta blanca y lisa por debajo
- otra capa flotando más arriba
- huecos entre capas que dejan ver el suelo
