# Cómo ayudan las luces del avión por la noche

Los aviones llevan varias luces diferentes, y no todas están ahí por la misma razón.
...
Ayudan a otros pilotos y controladores a reconocer:

- dónde está la aeronave
- hacia qué lado está orientada
...
Los aviones también usan luces intermitentes como balizas y estrobos.

Estas ayudan a indicar que:

- la aeronave está activa
- los motores pueden estar en marcha
- el avión está entrando en una pista o usándola
...
Una buena iluminación del avión ayuda a reducir esa dificultad al hacer que:
...
Las luces de los aviones forman parte de cómo la aviación se mantiene organizada después del anochecer.
