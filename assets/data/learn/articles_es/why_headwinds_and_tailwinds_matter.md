# Por qué importan los vientos de cara y de cola

Un avión se mueve a través del aire, no a través del suelo.
...
El avión puede seguir volando con normalidad a través del aire, pero sobre el suelo avanza más despacio.
...
Un **viento de cola** sopla en la misma dirección en la que viaja la aeronave.

Esto aumenta la velocidad sobre el suelo, lo que puede significar:
...
Por eso una aeronave puede tener:

- un rendimiento de vuelo normal
- pero una hora de llegada muy diferente
