# Qué ocurre durante el aterrizaje

El aterrizaje puede sentirse más incierto que el despegue: el suelo se acerca, los motores cambian de sonido y el avión empieza a frenar.
...
- Los motores reducen potencia
- El avión va perdiendo altitud gradualmente
- El morro puede inclinarse ligeramente hacia abajo

Puede que notes:
- un sonido de motor más suave
...
A medida que la aeronave se acerca al aeropuerto, necesita volar más despacio.

Para hacerlo, los pilotos extienden partes de las alas:

- Los **flaps** aumentan la sustentación a menor velocidad
- Los **slats** ayudan a controlar el flujo de aire

👉 Puede que oigas:
- ruidos mecánicos procedentes de las alas
...
- La velocidad se controla con mucho cuidado
- El descenso se vuelve muy estable
...
- el piloto eleva suavemente el morro
- las ruedas principales tocan primero la pista

👉 Puede que sientas:
- un pequeño golpe
- una sensación de rodadura
...
El aterrizaje puede sentirse:
- más “activo” que el despegue
- algo movido o ruidoso
