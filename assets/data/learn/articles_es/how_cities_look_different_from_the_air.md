# Cómo se ven las ciudades de forma distinta desde el aire

Desde el suelo, una ciudad se siente grande, llena de gente y de detalles.
...
Desde arriba, esos detalles se hacen pequeños y los patrones mayores se vuelven más claros.

Empiezas a notar:

- cuadrículas de calles
- barrios
- ríos
...
Desde el aire, se vuelve más fácil entender:

- por qué la ciudad creció donde creció
- cómo la modelaron los ríos, las costas o las colinas
- cómo conectan las carreteras distintas zonas
...
Una ciudad vista desde arriba es como:
