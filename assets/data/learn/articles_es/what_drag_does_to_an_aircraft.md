# Qué le hace la resistencia a una aeronave

Cada vez que un avión se mueve a través del aire, el aire se opone a ese movimiento.
...
- contra las alas
- contra el fuselaje
- contra el tren de aterrizaje, las antenas y otras superficies
...
- una velocidad alta necesita más potencia de motor
...
Las formas suaves y aerodinámicas crean menos resistencia que las formas voluminosas o rugosas.

Por eso los aviones se diseñan con:

- morros redondeados
- superficies lisas
- alas diseñadas para un flujo de aire limpio
...
Para que el avión siga moviéndose, el empuje debe superar a la resistencia.

Si:

- el empuje es mayor que la resistencia -> el avión acelera
- el empuje iguala la resistencia -> el avión mantiene la velocidad
- la resistencia es mayor que el empuje -> el avión frena
