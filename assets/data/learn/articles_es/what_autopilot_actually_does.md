...
Mantiene la aeronave estable y sobre la trayectoria planificada.
...
- los pilotos supervisan todo
- pueden tomar el control al instante
...
Antes del vuelo, se programa una ruta en el sistema.

Entonces el piloto automático puede:
- seguir puntos de paso
- mantener niveles de altitud
- ajustar la velocidad cuando hace falta
...
- ascender después del despegue
- mantener la altitud de crucero
- descender hacia el destino
