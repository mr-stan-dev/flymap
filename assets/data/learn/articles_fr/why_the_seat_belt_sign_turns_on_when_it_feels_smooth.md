# Pourquoi le signal ceinture s'allume alors que le vol parait fluide

Il arrive que le signal ceinture s'allume alors que le vol parait parfaitement calme.
...
- des informations meteorologiques
- des rapports d'autres avions
- l'experience de la route qui les attend
...
Le signal ceinture est la pour reduire les risques de blessure.

Meme un mouvement inattendu modere peut affecter :

- les passagers qui marchent dans l'allee
- le personnel de cabine au travail
- les objets non attaches dans la cabine
...
Le signal ceinture, c'est comme :
