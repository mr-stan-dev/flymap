# Les principales parties d'un avion

Un avion peut sembler etre une seule machine fluide, mais il est en realite compose de plusieurs grandes parties, chacune ayant une fonction precise.
...
C'est la que l'on trouve :

- les passagers
- le fret
- le cockpit
- de nombreux systemes de bord
...
- creer de la portance
- aider a soutenir l'avion dans l'air
- contenir le carburant sur de nombreux appareils
...
Elle comprend generalement :

- une derive verticale
...
Les moteurs poussent l'avion vers l'avant.

Ce mouvement vers l'avant est important, car il maintient l'air en ecoulement sur les ailes, ce qui permet a la portance d'exister.

Selon l'avion, les moteurs peuvent etre montes :
...
- le fuselage transporte
- les ailes portent
- l'empennage stabilise
