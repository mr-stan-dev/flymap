# Comment les aeroports maintiennent les pistes sures

Depuis la cabine, les pistes peuvent paraitre simples, mais elles sont gerees avec beaucoup de soin.
...
- les effets de la meteo
- l'eclairage
- l'utilisation par le trafic
...
La pluie, la neige, le verglas, les debris ou une mauvaise visibilite peuvent tous affecter l'exploitation des pistes.

Les aeroports repondent avec des procedures comme :
...
Maintenir une piste sure, c'est comme :
