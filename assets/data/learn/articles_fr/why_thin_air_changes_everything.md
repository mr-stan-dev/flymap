# Pourquoi l'air peu dense change tout

A haute altitude, l'air est bien plus peu dense qu'il ne l'est pres du sol.
...
- moins de molecules d'air
- moins de pression
- moins d'oxygene dans le meme volume d'espace
...
Dans un air moins dense :

- l'aile rencontre moins de molecules d'air
...
Les moteurs ont eux aussi besoin d'air.

Avec un air moins dense :

- moins d'oxygene entre dans le moteur
- les performances moteur changent

Cela est particulierement visible :

- dans les aeroports situes en altitude
...
- les ailes sont moins efficaces
- les moteurs peuvent produire moins de puissance

Cela peut signifier :

- des roulages de decollage plus longs
- des montees plus lentes
- plus de limites de performance
...
C'est l'une des raisons pour lesquelles les avions croisent haut dans l'atmosphere :

- la trainee est plus faible
- l'efficacite carburant s'ameliore
- les vols long-courriers deviennent plus efficaces
