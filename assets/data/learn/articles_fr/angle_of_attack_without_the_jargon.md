# L'angle d'attaque sans jargon

L'une des idees les plus importantes en aviation est l'**angle d'attaque**.
...
Quand l'aile rencontre l'air avec un angle un peu plus grand :

- elle peut creer plus de portance
- elle peut supporter plus de poids

C'est utile :

- au decollage
- en montee
- a vitesse plus faible
...
- l'ecoulement de l'air ne peut plus suivre l'aile de facon reguliere
- la portance baisse
...
Les pilotes n'ont pas besoin de penser a l'angle d'attaque comme a une simple theorie.

Ils le gerent grace a :

- la commande de tangage
- la vitesse
- la puissance
- les reglages de volets
...
Trop d'angle peut perturber l'ecoulement de l'air et reduire la portance.

L'objectif est de garder l'aile dans une zone intermediaire utile :
...
L'angle d'attaque est important parce qu'il influence :

- la portance
- la trainee
- le risque de decrochage
