# Pourquoi les ailes ont cette forme

Les ailes d'avion ne sont pas plates par hasard.
...
La plupart des ailes sont :

- plus epaisses a l'avant
- plus fines vers l'arriere
- doucement courbees
...
Elle y parvient en aidant l'aile a :

- diriger l'air vers le bas
- creer des differences de pression utiles
...
Une aile ne sert pas seulement a creer de la portance.

Elle doit aussi :

- rester solide
- contenir du carburant sur beaucoup d'avions
- bien fonctionner a basse et a haute vitesse
- rester controlable dans des conditions differentes
...
C'est pourquoi beaucoup d'avions possedent :

- des volets
- des becs
- des surfaces mobiles le long de l'aile
...
La forme de l'aile est l'une des parties les plus importantes de la conception d'un avion.

Elle affecte :

- la facilite avec laquelle l'avion quitte le sol
- la fluidite de son vol
