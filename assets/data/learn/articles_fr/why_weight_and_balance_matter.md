# Pourquoi le poids et l'equilibrage sont importants

Un avion ne se soucie pas seulement de son poids total.
...
Un poids supplementaire peut affecter :

- la distance de decollage
- les performances en montee
- la consommation de carburant
- les performances a l'atterrissage
...
Les pilotes et les planificateurs accordent une grande attention au **centre de gravite** de l'avion.

C'est le point ou le poids de l'appareil est considere comme s'exercant.

S'il est mal place, l'avion peut :
...
- l'endroit ou les passagers s'assoient
- l'endroit ou le fret est charge
...
Le poids et l'equilibrage sont une base du vol sur.
