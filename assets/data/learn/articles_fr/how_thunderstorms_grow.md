# Comment les orages se developpent
...
- de l'air chaud et humide pres du sol commence a monter
- en montant, il se refroidit
- la vapeur d'eau se transforme en gouttelettes de nuage
...
- l'air chaud continue de monter
- davantage d'humidite se condense
...
Quand le nuage se developpe :

- de forts courants ascendants emportent les gouttelettes d'eau plus haut
- les gouttelettes se regroupent et deviennent plus lourdes
- la pluie qui tombe cree des courants descendants

👉 Le nuage contient alors a la fois :
- de l'air montant (courants ascendants)
- de l'air descendant (courants descendants)
...
- les particules se heurtent et accumulent une charge electrique
- cela conduit a la foudre
...
- l'air ascendant rencontre une couche stable
- il ne peut plus monter
- il s'etale vers l'exterieur
...
- des mouvements verticaux soudains de l'air
...
Depuis le dessus, les orages ressemblent :

- a de grandes tours qui s'elevent au-dessus des autres nuages
- avec un sommet plat qui s'etale
- projetant de grandes ombres
