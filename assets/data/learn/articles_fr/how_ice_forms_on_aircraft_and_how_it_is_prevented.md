# Comment la glace se forme sur un avion et comment on l'empeche

La glace sur un avion est un probleme plus important que beaucoup ne l'imaginent.
...
Quand ces gouttelettes touchent une surface de l'avion, elles peuvent geler au contact.

Cela est plus probable sur :
...
Les surfaces d'un avion sont dessinees avec beaucoup de precision.

Si de la glace s'accumule, elle peut :

- perturber l'ecoulement de l'air
- augmenter la trainee
- reduire la portance
- affecter les sondes et la visibilite
...
Beaucoup d'avions disposent de systemes qui empechent la glace de se former ou l'enlevent en vol.

Ces systemes peuvent utiliser :

- de la chaleur
- de l'air chaud provenant du moteur
- des systemes speciaux sur les surfaces
...
La glace sur un avion, c'est comme :
