# Comment fonctionne le Wi-Fi à bord

Se connecter à Internet à l’altitude de croisière semble presque banal. Derrière la page de connexion, un message peut pourtant partir de la cabine vers l’espace, revenir sur Terre, puis rejoindre Internet.
...
Une antenne installée sous un carénage lisse sur le dessus de l’avion suit un satellite. Le signal monte jusqu’à celui-ci, redescend vers une passerelle terrestre reliée à Internet, puis les réponses parcourent le trajet inverse.

Certains systèmes utilisent des satellites très hauts, tandis que des réseaux plus récents emploient des constellations en orbite plus basse. La distance, la couverture, l’antenne et la capacité du réseau influencent toutes la vitesse et le délai.
...
Des centaines de passagers peuvent partager une capacité limitée. Vidéos, gros téléchargements, sauvegardes en ligne et mises à jour se la disputent rapidement.

Une zone sans couverture, un changement de satellite, la position de l’avion, la saturation du réseau terrestre ou des règles locales peuvent couper le service. La compagnie peut aussi ne l’activer qu’après le décollage ou l’arrêter avant l’atterrissage.
...
Le téléphone communique alors avec le réseau installé et approuvé de l’avion, au lieu de chercher les antennes mobiles très éloignées au sol. Si le service propose des messages ou des appels, ils passent eux aussi par la connexion Internet de bord.
