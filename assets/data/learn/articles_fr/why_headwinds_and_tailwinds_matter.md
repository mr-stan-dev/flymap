# Pourquoi les vents de face et les vents arriere comptent

Un avion se deplace dans l'air, pas sur le sol.
...
L'avion peut toujours voler normalement dans l'air, mais par rapport au sol il avance plus lentement.
...
Un **vent arriere** souffle dans la meme direction que celle de l'avion.

Cela augmente la vitesse sol, ce qui peut signifier :

- un temps de vol plus court
- une meilleure efficacite carburant
...
C'est pourquoi un avion peut avoir :

- des performances de vol normales
- mais une heure d'arrivee tres differente
