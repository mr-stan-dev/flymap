# Pourquoi les jours chauds rendent le decollage plus difficile

Un temps chaud peut sembler inoffensif au sol, mais pour un avion il peut rendre le decollage plus exigeant.
...
Les ailes ont besoin d'un ecoulement d'air dense pour creer efficacement de la portance.

Par jour chaud :

- la portance se construit plus lentement
- l'avion peut avoir besoin de plus de vitesse sur la piste
...
Dans un air plus chaud et plus fin :

- il y a moins d'oxygene dans le meme volume
- la performance moteur peut diminuer
...
Par temps chaud, les avions peuvent avoir besoin de :

- pistes plus longues
- poids plus faible
- planification de performance plus soigneuse
