# Pourquoi les decrochages se produisent

Un decrochage parait dramatique, mais cela ne veut pas dire que le moteur s'est arrete.
...
Mais un decrochage aerodynamique est different.

Il se produit lorsque :

- l'aile atteint un angle d'attaque trop eleve
- l'ecoulement de l'air ne peut plus rester attache en douceur
...
- l'ecoulement commence a se separer
- la trainee augmente
...
Le decrochage est souvent associe a un vol lent, et c'est vrai dans de nombreuses situations.

Mais la cause reelle n'est pas simplement une faible vitesse.

Un decrochage peut se produire des que l'aile depasse son angle d'attaque critique, y compris :

- pendant des virages serres
...
La sortie du decrochage signifie generalement :

- reduire l'angle d'attaque
- laisser l'ecoulement se rattacher
...
Les passagers ne subissent generalement pas de decrochage en exploitation normale sur les vols de ligne.

L'aviation commerciale reste largement dans ses marges de securite.

Comprendre le decrochage aide pourtant a expliquer pourquoi les pilotes sont attentifs a :
...
- la portance depend d'un ecoulement fluide
