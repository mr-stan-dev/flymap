# Pourquoi la nourriture a un gout different dans les airs

Beaucoup de gens remarquent que la nourriture et les boissons ont un gout un peu different dans un avion.
...
Une grande partie de ce que tu appelles le gout vient en realite de ton odorat.

Quand l'odorat est affecte, la nourriture peut sembler :
...
Cela peut rendre certaines saveurs moins presentes, en particulier :
...
Les repas servis en vol sont pris dans un environnement different de celui des repas au sol.

Les passagers peuvent aussi composer avec :

- le bruit
- la fatigue
- le stress du voyage
- des horaires de repas inhabituels
...
La nourriture en vol, c'est comme :
