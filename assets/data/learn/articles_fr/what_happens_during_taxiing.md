# Ce qui se passe pendant le roulage

Avant le decollage et apres l'atterrissage, les avions passent du temps a se deplacer au sol.
...
- quitter la porte
- se diriger vers la piste
- quitter la piste apres l'atterrissage
- rejoindre la position de stationnement
...
L'avion avance lentement parce que :

- les aeroports sont tres actifs
- les virages peuvent etre serres
- d'autres avions et vehicules peuvent etre proches
...
Au sol, les pilotes recoivent aussi des instructions sur :

- la voie de circulation a utiliser
- le moment ou s'arreter
...
Le roulage peut sembler simple depuis la cabine, mais les pilotes sont tres occupes.

Ils surveillent :

- les panneaux et marquages de circulation
- les autres avions
- les vehicules au sol
- les systemes de l'avion avant le decollage
...
Cela peut sembler lent, mais c'est :

- soigneusement controle
- tres procedural
