# Pourquoi les vols de nuit paraissent si differents

Un vol de nuit peut donner l'impression d'un monde completement different d'un vol de jour.
...
Ce qui ressort, c'est plutot ce qui produit ou reflete assez de lumiere, comme :

- les villes
- les routes
- les aeroports
- les cotes pres des zones habitees
...
La nuit, tu remarques plus souvent :

- des groupes de lumieres
- des reseaux routiers
- des lignes de circulation en mouvement
...
Cela vient en partie du fait que l'obscurite supprime de nombreux reperes visuels.
