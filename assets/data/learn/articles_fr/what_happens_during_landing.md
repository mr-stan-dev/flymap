# Ce qui se passe pendant l'atterrissage

L'atterrissage peut sembler plus incertain que le decollage - le sol se rapproche, le bruit des moteurs change et l'avion commence a ralentir.
...
- Les moteurs reduisent leur puissance
- L'avion perd progressivement de l'altitude
- Le nez peut s'incliner legerement vers le bas

Tu peux remarquer :
- un bruit moteur plus calme
...
Quand l'avion se rapproche de l'aeroport, il doit ralentir.

Pour cela, les pilotes deployent certaines parties des ailes :

- les **volets** augmentent la portance a basse vitesse
- les **becs** aident a controler l'ecoulement de l'air

👉 Tu peux entendre :
- des bruits mecaniques venant des ailes
- de legers changements de mouvement
...
- La vitesse est soigneusement controlee
- La descente devient tres reguliere
...
- Le pilote releve doucement le nez
- Les roues principales touchent la piste en premier

👉 Tu peux ressentir :
- une breve secousse
- une sensation de roulage
...
- les freins de roue
- la poussee inverse des moteurs
...
L'atterrissage peut sembler :
- plus "actif" que le decollage
- legerement cahoteux ou bruyant
