# Winglets : petites extremites, grand effet

Aux extremites de nombreuses ailes modernes, on peut voir de petites extensions dirigees vers le haut ou inclinees.
...
Les winglets sont concues pour reduire l'intensite de cet ecoulement d'air indésirable autour de l'extremite.

Elles aident a :

- reduire les vortex marginaux
- ameliorer l'efficacite
- diminuer la trainee en croisiere
...
Les winglets sont surtout connues pour faire economiser du carburant, mais elles peuvent aussi aider les performances.

Dans certains cas, elles peuvent ameliorer :

- l'efficacite en montee
- les performances en croisiere
- la flexibilite de charge utile
...
- de simples winglets vers le haut
- des winglets dedoublees
- des extremites courbees
- des extremites effilees plutot que des winglets classiques
...
Elles aident les avions a :

- gaspiller moins d'energie
- reduire la trainee
