...
Au premier regard, il peut sembler surprenant qu'une machine aussi grande et aussi lourde qu'un avion puisse rester dans le ciel.
...
Quand un avion avance, l'air s'ecoule :
- au-dessus des ailes
...
Les ailes d'avion sont specialement profilees pour generer de la **portance** - une force vers le haut.

Quand l'air s'ecoule sur l'aile :
- il va plus vite au-dessus
- la pression devient plus faible au-dessus de l'aile
- la pression plus elevee en dessous pousse l'aile vers le haut
...
C'est pourquoi les moteurs sont importants - ils :
- poussent l'avion vers l'avant
...
Le vol est une question d'equilibre entre quatre forces :

- Portance (vers le haut)
- Poids (vers le bas)
- Poussee (vers l'avant)
- Trainee (vers l'arriere)
...
- il va assez vite
- ses ailes sont grandes et efficaces
- l'air le soutient en permanence
