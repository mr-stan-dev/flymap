# Wie sich Eis an Flugzeugen bildet und wie es verhindert wird

Eis an einem Flugzeug ist ein größeres Problem, als vielen Menschen bewusst ist.
...
Wenn diese Tropfen auf eine Flugzeugoberfläche treffen, können sie beim Kontakt gefrieren.

Das ist besonders wahrscheinlich an:
...
Flugzeugoberflächen sind sehr sorgfältig gestaltet.

Wenn sich Eis aufbaut, kann es:

- die Luftströmung stören
- den Widerstand erhöhen
- den Auftrieb verringern
- Sensoren und Sicht beeinträchtigen
...
Viele Flugzeuge haben Systeme, die Eis in der Luft verhindern oder entfernen.

Dafür können sie nutzen:

- Wärme
- heiße Triebwerksluft
- spezielle Oberflächensysteme
...
Eis auf einem Flugzeug ist wie:
