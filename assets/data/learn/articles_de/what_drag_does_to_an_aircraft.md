# Was Widerstand mit einem Flugzeug macht

Immer wenn sich ein Flugzeug durch die Luft bewegt, widersetzt sich die Luft dieser Bewegung.
...
- an den Flügeln
- am Rumpf
- am Fahrwerk, an Antennen und anderen Oberflächen
...
- hohe Geschwindigkeit braucht mehr Triebwerksleistung
...
Glatte, stromlinienförmige Formen erzeugen weniger Widerstand als klobige oder raue Formen.

Deshalb werden Flugzeuge konstruiert mit:

- abgerundeten Nasen
- glatten Oberflächen
- Flügeln, die für saubere Luftströmung geformt sind
...
Er kann zunehmen, wenn:

- Klappen ausgefahren sind
- das Fahrwerk unten ist
...
Damit sich das Flugzeug weiterbewegt, muss der Schub den Widerstand übertreffen.

Wenn:

- der Schub größer als der Widerstand ist -> beschleunigt das Flugzeug
- Schub und Widerstand gleich groß sind -> hält das Flugzeug seine Geschwindigkeit
- der Widerstand größer als der Schub ist -> wird das Flugzeug langsamer
...
- unnötigen Widerstand zu verringern
