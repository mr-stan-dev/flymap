# Wie Kurven den Auftrieb verändern

Ein Flugzeug zu drehen bedeutet nicht einfach nur, es seitlich auszurichten.
...
Im Geradeausflug wirkt der Auftrieb hauptsächlich dem Gewicht entgegen.

In einer Kurve kippt der Auftrieb mit dem Flugzeug:

- ein Teil trägt das Flugzeug weiterhin nach oben
...
Weil ein Teil des Auftriebs nun die Kurve unterstützt, statt das Flugzeug nur oben zu halten, braucht das Flugzeug oft zusätzlichen Auftrieb, um die Höhe zu halten.

Der kann kommen durch:

- einen etwas größeren Anstellwinkel
...
- desto mehr Auftrieb wird benötigt
- desto höher wird die Belastung des Flügels
- desto kleiner kann die Reserve bis zum Strömungsabriss werden
...
Der Flügel erzeugt weiterhin Auftrieb, aber dieser Auftrieb muss jetzt zwei Aufgaben erfüllen:
