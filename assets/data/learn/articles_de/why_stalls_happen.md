# Warum ein Strömungsabriss entsteht

Ein Strömungsabriss klingt dramatisch, bedeutet aber nicht, dass das Triebwerk ausgegangen ist.
...
Ein aerodynamischer Strömungsabriss ist aber etwas anderes.

Er passiert, wenn:

- der Flügel einen zu hohen Anstellwinkel erreicht
- die Luftströmung nicht mehr glatt anliegen kann
- der Auftrieb stark abfällt
...
- beginnt sich die Strömung zu lösen
...
Ein Strömungsabriss wird oft mit langsamen Fliegen verbunden, und das stimmt in vielen Situationen.

Aber die eigentliche Ursache ist nicht einfach nur geringe Geschwindigkeit.

Ein Strömungsabriss kann immer dann passieren, wenn der Flügel seinen kritischen Anstellwinkel überschreitet, zum Beispiel:
...
Die Erholung bedeutet meist:

- den Anstellwinkel zu verringern
- die Strömung wieder anliegen zu lassen
...
Passagiere erleben Strömungsabrisse im normalen Linienflug normalerweise nicht.

Die kommerzielle Luftfahrt bleibt deutlich innerhalb sicherer Grenzen.

Trotzdem hilft das Verständnis davon zu erklären, warum Piloten so genau auf Folgendes achten:
...
- Auftrieb hängt von glatter Luftströmung ab
