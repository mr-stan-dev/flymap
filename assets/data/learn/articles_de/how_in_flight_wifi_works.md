# Wie WLAN im Flugzeug funktioniert

Sich auf Reiseflughöhe mit dem WLAN zu verbinden, fühlt sich beinahe alltäglich an. Hinter dem Anmeldebildschirm kann eine Nachricht jedoch von der Kabine ins All, zurück zur Erde und erst dann durch das Internet reisen.
...
Bei einem Satellitendienst verfolgt eine Antenne unter einer glatten Abdeckung auf der Oberseite des Flugzeugs einen Satelliten. Das Signal läuft vom Flugzeug zum Satelliten und anschließend zu einer Bodenstation mit Verbindung zum weltweiten Internet. Die Antwort nimmt den umgekehrten Weg.

Einige Systeme verwenden Satelliten in sehr großer Höhe, neuere Netze teilweise Gruppen tiefer fliegender Satelliten. Entfernung, Abdeckung, Bauart der Antenne und Netzkapazität beeinflussen Geschwindigkeit und Verzögerung.
...
Hunderte Passagiere teilen sich möglicherweise eine begrenzte Kapazität. Videos, große Downloads, Datensicherungen in der Cloud und Softwareupdates konkurrieren schnell darum.

Lücken in der Abdeckung, Übergaben zwischen Satelliten, die Lage des Flugzeugs, ein ausgelastetes Bodennetz oder regionale Vorschriften können den Dienst unterbrechen. Airlines schalten das System mitunter erst nach dem Start ein oder schon vor der Landung wieder aus.
...
Das Smartphone nutzt dann das zugelassene Bordnetz des Flugzeugs. Es versucht nicht, einen gewöhnlichen Anruf über weit entfernte Mobilfunkmasten am Boden aufzubauen. Bietet ein Dienst Nachrichten oder Anrufe an, laufen auch sie über die Internetverbindung des Flugzeugs.
