# Was Flughafen-Slots sind und warum Verspätungen sich fortpflanzen

„Wir warten auf einen Slot“ klingt, als hätte der Flughafen einen Parkplatz verlegt.
...
Wenn Piloten sagen, sie warteten auf einen Slot, können sie statt des saisonalen Flughafen-Slots eine taktische Zeitvorgabe der Flugsicherung meinen.

Gewitter können einen Teil der Route sperren, Nebel kann Ankünfte verlangsamen, eine Bahn kann ausfallen oder ein Flugsicherungssektor seine sichere Arbeitsbelastung erreichen. Dann können Verkehrsmanager den betroffenen Flügen eine geregelte Abflugzeit oder ein Startfenster zuweisen.

Bezeichnungen und Verfahren unterscheiden sich je nach Region. In Europa kann dies ein Slot des Verkehrsflussmanagements mit einer berechneten Startzeit sein. In den USA kann ein Bodenverzögerungsprogramm eine erwartete Abflugfreigabezeit zuteilen, damit die Ankünfte an einem überlasteten Flughafen dosiert eintreffen.
...
Ein Verkehrsflugzeug fliegt selten nur einmal am Tag. Nach der Landung bringt dieselbe Maschine vielleicht eine andere Gruppe von Passagieren in eine weitere Stadt. Piloten und Kabinencrew wechseln womöglich auf spätere Flüge, und das Gate wird für die nächste Ankunft benötigt.

Eine Verspätung auf der ersten Strecke kann deshalb die nächste Bodenzeit verkürzen und spätere Abflüge nach hinten verschieben. Umsteigende Passagiere, Gepäck, Catering, Wartungskontrollen, Dienstzeitgrenzen der Crew, Nachtflugbeschränkungen und eine weitere Stoßzeit an einem anderen Flughafen können neue Hindernisse hinzufügen.
