# Wie Wetterradar Piloten hilft

Von deinem Sitz aus mag der Himmel ruhig aussehen -  
aber Piloten haben Werkzeuge, die zeigen, was **in den Wolken vor ihnen** passiert.
...
Diese Signale:
- laufen nach vorn
- treffen auf Teilchen wie Regen oder Eis
...
Wetterradar ist besonders gut darin, Folgendes zu finden:

- Regen
- nassen Hagel oder Eis
- Gewitterzellen mit starkem Niederschlag

👉 Stärkere Rückmeldungen bedeuten normalerweise:
- stärkeren Regen
...
Mit Hilfe des Radars können Piloten:

- die Richtung anpassen
- die Höhe ändern
- um Gewitterzellen herumfliegen

👉 Das hilft, Folgendes zu vermeiden:
- starke Turbulenz
- starken Regen
...
- Piloten interpretieren die Daten
...
- können Wolken weich und harmlos wirken
