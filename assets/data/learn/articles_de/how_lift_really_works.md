# Wie Auftrieb wirklich funktioniert

Auftrieb ist die Kraft, die einem Flugzeug hilft, in den Himmel zu steigen.
...
Diese Strömung kann kommen von:

- der Vorwärtsbewegung des Flugzeugs
...
Ein Flugzeugflügel ist so geformt, dass die Luft glatt an ihm vorbeiströmt.

Wenn Luft auf den Flügel trifft:

- strömt ein Teil über die Oberseite
- strömt ein Teil unter die Unterseite
- lenkt der Flügel einen Teil dieser Strömung nach unten
...
Die Strömung um den Flügel erzeugt auch:

- geringeren Druck über dem Flügel
...
Je schneller sich das Flugzeug bewegt, desto mehr Luft strömt über den Flügel.

Das bedeutet normalerweise:

- mehr Auftrieb
- leichteres Steigen
- bessere Unterstützung für das Gewicht des Flugzeugs
...
- größer als das Gewicht wird -> kann das Flugzeug steigen
...
Auftrieb ist keine Magie und der Flügel „schwebt“ nicht einfach.
...
- Luftströmung
- Druckunterschieden
- der Umlenkung von Luft nach unten durch den Flügel
