...
class TranslationsDe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsSkyCameraDe skyCamera = _TranslationsSkyCameraDe._(_root);
	@override late final _TranslationsMediaDe media = _TranslationsMediaDe._(_root);
...
class _TranslationsHomeDe extends TranslationsHomeEn {
	...
	@override String get tabLearn => 'Lernen';
	@override String get tabMedia => 'Medien';
	@override String get openSkyCamera => 'Sky Camera öffnen';
...
// Path: skyCamera
class _TranslationsSkyCameraDe extends TranslationsSkyCameraEn {
	_TranslationsSkyCameraDe._(TranslationsDe root) : this._root = root, super.internal(root);

	final TranslationsDe _root; // ignore: unused_field

	// Translations
	@override String get loading => 'Kamera wird geladen...';
	@override String get loadingGpsData => 'GPS-Daten werden geladen';
	@override String get zoom => 'Zoom';
	@override String get flash => 'Blitz';
	@override String get cameraUnavailable => 'Die Kamera ist gerade nicht verfügbar.';
	@override String get cameraPermissionDenied => 'Für Fotos und Videoaufnahmen wird Kamerazugriff benötigt.';
	@override String get captureFailed => 'Diese Aufnahme konnte gerade nicht gespeichert werden.';
	@override String get savedMessage => 'Foto gespeichert';
	@override String get share => 'Teilen';
	@override String get noActiveFlightTitle => 'Kein aktiver Flug';
	@override String get noActiveFlightMessage => 'Sky Camera funktioniert auch ohne Flug, aber Routendetails erscheinen nur während eines aktiven Flugs.';
	@override String get telemetrySpeed => 'Geschwindigkeit';
	@override String get telemetryAltitude => 'Höhe';
	@override String get telemetryHeading => 'Kurs';
	@override String get telemetryTime => 'Zeit';
	@override String get contextCaption => 'Kontext';
	@override String get mapCaption => 'Karte';
	@override String get coordinatesCaption => 'Koordinaten';
	...
	@override String get placeholderContext => 'Mittelmeer';
	@override String get placeholderMap => 'Routenvorschau';
	@override String get settingsTitle => 'Kameraeinstellungen';
	@override String get recordAudio => 'Ton aufnehmen';
	@override String get recordAudioHint => 'Videos nehmen Mikrofonton auf.';
	@override String get microphonePermissionDenied => 'Mikrofonzugriff ist aus — Videos werden ohne Ton aufgenommen.';
	@override String get lowStorageRecordingBlocked => 'Gib Speicherplatz frei, bevor du ein Video aufnimmst.';
	@override String get lowStorageRecordingStopped => 'Die Aufnahme wurde gestoppt und gespeichert, weil der Speicher fast voll ist.';
	@override String get lowStorageVideoExport => 'Gib Speicherplatz frei, bevor du dieses Video vorbereitest.';
	@override String get hotDeviceRecordingBlocked => 'Dein Gerät ist zu heiß für eine Aufnahme. Lass es abkühlen und versuche es erneut.';
	@override String get hotDeviceRecordingStopped => 'Die Aufnahme wurde gestoppt und gespeichert, weil dein Gerät zu heiß ist.';
	@override String get preparingVideo => 'Video wird vorbereitet…';
}

// Path: media
class _TranslationsMediaDe extends TranslationsMediaEn {
	_TranslationsMediaDe._(TranslationsDe root) : this._root = root, super.internal(root);

	final TranslationsDe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Medien vom Fensterplatz';
	@override String get loading => 'Medien werden geladen...';
	@override String get failedToLoad => 'Medien konnten nicht geladen werden';
	@override String get filesTab => 'Dateien';
	@override String get flightsTab => 'Flüge';
	@override String get emptyTitle => 'Willkommen bei deiner Sky Camera am Fensterplatz';
	@override String get emptySubtitle => 'Halte wunderschöne Ausblicke von deinem Fensterplatz fest und teile sie mit Flug- und GPS-Daten-Overlays.';
	@override String get emptyFlightsTitle => 'Noch keine Flugordner';
	@override String get emptyFlightsSubtitle => 'Mit gespeicherten Flügen verknüpfte Aufnahmen erscheinen hier.';
	@override String get deleteAction => 'Löschen';
	@override String get share => 'Teilen';
	@override String selectedCount({required Object count}) => '${count} ausgewählt';
	@override String get groupNoFlight => 'Kein Flugkontext';
	@override String get groupNoFlightSubtitle => 'Aufnahmen außerhalb eines aktiven Flugs';
	@override String get groupUnknownFlight => 'Flugaufnahme';
	@override String get previewTitle => 'Aufnahme';
	@override String captureCount({required Object count}) => '${count} Aufnahmen';
	@override String get deleteFolder => 'Ordner löschen';
	@override String deleteFolders({required Object count}) => '${count} Ordner löschen';
	@override String get deleteFile => 'Datei löschen';
	@override String deleteFiles({required Object count}) => '${count} Dateien löschen';
	@override String deleteFolderConfirm({required Object count}) => 'Diesen Ordner und alle ${count} Dateien löschen?';
	@override String deleteFoldersConfirm({required Object count}) => '${count} Ordner und alle enthaltenen Dateien löschen?';
	@override String get deleteFileConfirm => 'Diese Datei löschen?';
	@override String deleteFilesConfirm({required Object count}) => '${count} Dateien löschen?';
}
...
class _TranslationsSettingsDe extends TranslationsSettingsEn {
	...
	@override String get historyRestoreFlight => 'Flug wiederherstellen';
	@override String get historyRestoreSuccess => 'Der Flug wurde als bevorstehend wiederhergestellt.';
	@override String get historyRestoreError => 'Flug konnte nicht wiederhergestellt werden.';
	...
	@override late final _TranslationsSettingsNotificationsDe notifications = _TranslationsSettingsNotificationsDe._(_root);
	...
	@override String get advocacyDialogTitle => 'Schön, dass dir Flymap gefällt';
	@override String get advocacyDialogBody => 'Hilf anderen Reisenden, Flymap zu entdecken.';
	@override String get advocacyDialogShare => 'Mit Freunden teilen';
	@override String get advocacyDialogRate => 'Flymap bewerten';
	@override String get advocacyDialogNotNow => 'Nicht jetzt';
...
class _TranslationsPreviewDe extends TranslationsPreviewEn {
	...
	@override String get openFlight => 'Flug öffnen';
...
class _TranslationsFlightDe extends TranslationsFlightEn {
	...
	@override late final _TranslationsFlightHubDe hub = _TranslationsFlightHubDe._(_root);
...
class _TranslationsFlightVideoDe extends TranslationsFlightVideoEn {
	...
	@override String get avatarTitle => 'Dein Avatar';
	@override String get avatarHint => 'Fliege deine Route mit deinem eigenen Foto';
	@override String get avatarSetupTitle => 'Dein Avatar';
	@override String get avatarPick => 'Foto wählen';
	@override String get avatarChange => 'Foto ändern';
	@override String get avatarNameLabel => 'Name oder @Handle';
	@override String get avatarNameHint => 'Optional – auf der Zusammenfassungskarte sichtbar';
	@override String get avatarSave => 'Avatar speichern';
	@override String get mysteryTitle => 'Rate, wohin ich fliege? ✈️';
	@override String get avatarCardTagline => 'Meine Flugkarte';
}
...
class _TranslationsNotificationsDe extends TranslationsNotificationsEn {
	...
	@override String get forecastUpdatedTitle => 'Dein Flug ist morgen';
	@override String forecastUpdatedBody({required Object route}) => '${route} — öffne Flymap für die aktuelle Vorhersage.';
	...
	@override String reminderTomorrowBody({required Object route}) => '${route} morgen — vergiss nicht, die App im Flug zu öffnen und alles zu entdecken, was du überfliegst.';
}
...
class _TranslationsOnboardingDe extends TranslationsOnboardingEn {
	...
	@override String get interestsTitle => 'Welche Orte möchtest du häufiger auf deiner Karte sehen?';
...
class _TranslationsLearnGeoQuizDe extends TranslationsLearnGeoQuizEn {
	...
	@override String get geographyTitle => 'Geografie';
	@override String get geographySubtitle => 'Meere, Gebirge, Seen, Inseln und mehr';
	...
	@override String get countryHint => 'Regionsname...';
	...
	@override String get hintTitle => 'Hinweis';
	@override String get hintSubtitle => 'Tippe auf einen Buchstaben, um ihn aufzudecken';
	...
	@override String get quizCountriesAfricaTitle => 'Afrika';
	@override String get quizCountriesEuropeTitle => 'Europa';
	@override String get quizCountriesAsiaTitle => 'Asien';
	@override String get quizCountriesNorthAmericaTitle => 'Nordamerika';
	@override String get quizCountriesSouthAmericaTitle => 'Südamerika';
	@override String get quizCountriesOceaniaTitle => 'Ozeanien';
	@override String get quizCountriesAllTitle => 'Alle Länder';
	@override String get quizCountriesSubtitle => 'Länder';
	@override String get quizCountriesAllSubtitle => 'Welt';
	@override String get quizGeographySeasTitle => 'Meere';
	@override String get quizGeographyMountainRangesTitle => 'Gebirge';
	@override String get quizGeographyLakesTitle => 'Seen';
	@override String get quizGeographyIslandsTitle => 'Inseln';
	@override String get quizGeographyOtherTitle => 'Weitere';
	@override String get quizGeographyOtherSubtitle => 'Buchten, Meerengen, Golfe, Wüsten und mehr';
	@override String get descriptionUnavailable => 'Beschreibung ist noch nicht verfügbar.';
}

// Path: settings.notifications
class _TranslationsSettingsNotificationsDe extends TranslationsSettingsNotificationsEn {
	_TranslationsSettingsNotificationsDe._(TranslationsDe root) : this._root = root, super.internal(root);
	...
	@override String get summaryOn => 'Ein';
	@override String get summaryOff => 'Aus';
}
...
class _TranslationsCreateFlightWeatherDe extends TranslationsCreateFlightWeatherEn {
	...
	@override String get continueWithoutWeather => 'Ohne Wetter fortfahren';
	@override String get noDateTitle => 'Flugdatum & Uhrzeit hinzufügen';
	@override String get noDatePickBody => 'Für eine Wettervorhersage werden dein Flugdatum und deine Abflugzeit benötigt.';
	@override String get noDatePickButton => 'Datum & Uhrzeit wählen';
	@override String get noDateRealBody => 'Ohne dein Flugdatum ist keine Wettervorhersage möglich. Wähle ein Datum aus, wenn du diesen Flug auswählst, um das Wetter zu sehen.';
	@override String get noDateBackButton => 'Zurück, um ein Datum zu wählen';
	@override String get forecastTooFarTitle => 'Für eine zuverlässige Vorhersage ist es noch zu früh';
	@override String forecastTooFarBody({required Object days}) => 'Wettervorhersagen sind nur bis zu ${days} Tage im Voraus verlässlich. Wir benachrichtigen dich vor deinem Flug, sobald eine zuverlässige Vorhersage verfügbar ist.';
	@override String get pastForecastTitle => 'Dieses Flugdatum ist bereits vorbei';
	@override String get pastForecastBody => 'Für vergangene Flüge sind keine Vorhersagen verfügbar.';
	@override String get notificationPermissionHint => 'Benachrichtigungen sind aus. Aktiviere sie, damit dich die Vorhersage-Erinnerung erreichen kann.';
	...
	@override String get estimatedShort => 'geschätzt';
	...
	@override String get windWindy => 'Windig';
	@override String get windStrong => 'Starker Wind';
	@override String get proTeaserTitle => 'Schalte Flughafenwetter und Wolken entlang deiner Route frei';
	@override String attribution({required Object provider, required Object license}) => 'Basierend auf Daten von ${provider} · Visualisierung durch Flymap · ${license}';
	@override String attributionShare({required Object provider, required Object license}) => 'Daten: ${provider} · Visualisierung: Flymap · ${license}';
	@override String get hedge => 'Vorhersagen werden näher am Abflug genauer.';
	@override String get share => 'Teilen';
	@override String get shareAsImage => 'Als Bild teilen';
	@override String get shareAsVideo => 'Als Video teilen';
	@override String get preparingShare => 'Teilen wird vorbereitet…';
	@override String get shareFailed => 'Teilen konnte nicht vorbereitet werden — versuche es erneut.';
	@override String updatedRelative({required Object relative}) => 'Aktualisiert ${relative}';
	@override String updatedExact({required Object date, required Object time}) => 'Aktualisiert ${date}, ${time}';
	@override String get updatedJustNow => 'gerade eben';
	@override String updatedMinutesAgo({required Object minutes}) => 'vor ${minutes} Min.';
	@override String updatedHoursAgo({required Object hours}) => 'vor ${hours} Std.';
}
...
class _TranslationsCreateFlightTravelDateDe extends TranslationsCreateFlightTravelDateEn {
	...
	@override String get pickDate => 'Reisedatum auswählen';
	@override String get yourFlightOnDate => 'Dein Flug an diesem Datum';
	@override String get changeDate => 'Datum ändern';
	@override String get checkingSchedule => 'Flugplan wird geprüft…';
	@override String get noDateYet => 'Noch kein Datum';
	@override String get skipDate => 'Ohne Datum fortfahren';
	@override String get skipDateTimeScreen => 'Datum & Uhrzeit überspringen';
	@override String get addDepartureTime => 'Abflugzeit hinzufügen';
	@override String departureTimeAt({required Object time}) => 'Abflugzeit · ${time}';
	@override String get departureTimeTitle => 'Abflugzeit';
	@override String get departureTimeHint => 'Lege die lokale Abflugzeit fest, um fortzufahren.';
	@override String get departureTimePickDateFirst => 'Wähle zuerst ein Datum und lege dann die Abflugzeit fest.';
	@override String get setDepartureTime => 'Abflugzeit festlegen';
	@override String departureTimeSelected({required Object time}) => 'Abflug · ${time}';
	@override String get notificationPermissionTitle => 'Flugerinnerungen erhalten';
	@override String get notificationPermissionBody => 'Erlaube Mitteilungen, damit Flymap dich daran erinnern kann, vor deinem Flug das aktuelle Wetter zu prüfen.';
	@override String get notificationPermissionNotNow => 'Nicht jetzt';
	@override String get notificationPermissionAllow => 'Mitteilungen erlauben';
	@override String get noDepartureOnDateTitle => 'Wir konnten diesen Flug an diesem Datum nicht finden';
	@override String get noDepartureOnDateBody => 'Prüfe das Datum oder lege die Abflugzeit manuell fest, um fortzufahren.';
	@override String get dateCheckFailed => 'Datum konnte nicht geprüft werden. Lege die Abflugzeit manuell fest, um fortzufahren.';
}
...
class _TranslationsCreateFlightFlightNumberSearchDe extends TranslationsCreateFlightFlightNumberSearchEn {
	...
	@override String get editFlightNumber => 'Flugnummer ändern';
...
class _TranslationsCreateFlightRealRouteAirportSearchDe extends TranslationsCreateFlightRealRouteAirportSearchEn {
	...
	@override String foundOneTitle({required Object route}) => '1 Flug gefunden · ${route}';
	@override String foundManyTitle({required Object count, required Object route}) => '${count} Flüge gefunden · ${route}';
...
// Path: flight.hub
class _TranslationsFlightHubDe extends TranslationsFlightHubEn {
	_TranslationsFlightHubDe._(TranslationsDe root) : this._root = root, super.internal(root);

	final TranslationsDe _root; // ignore: unused_field

	// Translations
	@override String get timelineTitle => 'Timeline';
	@override String timelineSubtitle({required Object count}) => '${count} Regionen entlang deiner Route';
	@override String get placesTitle => 'Orte';
	@override String placesSubtitle({required Object count}) => '${count} Orte aus deinem Fenster zu entdecken';
	@override String get filterAll => 'Alle';
	@override String get noPlaces => 'Keine Orte für diesen Flug gespeichert.';
	@override String get weatherTitle => 'Wetter';
	@override String get weatherCheck => 'Prüfe deine Vorhersage';
	@override String get weatherTooEarly => 'Noch zu früh für eine zuverlässige Vorhersage — wir benachrichtigen dich';
	@override String get weatherLocked => 'Wolkenkarte und Flughafenwetter — Pro';
	@override String get articlesTitle => 'Artikel';
	@override String articlesSubtitle({required Object count}) => '${count} Artikel offline gespeichert';
}
...
class _TranslationsFlightDashboardDe extends TranslationsFlightDashboardEn {
	...
	@override String get gpsEstimatedShort => 'Geschätzt';
	@override String get gpsLastKnownShort => 'Letzte Pos.';
	@override String get gpsLastTelemetryShort => 'Zuletzt';
...
class _TranslationsOnboardingPayoffDe extends TranslationsOnboardingPayoffEn {
	_TranslationsOnboardingPayoffDe._(TranslationsDe root) : this._root = root, super.internal(root);

	final TranslationsDe _root; // ignore: unused_field

	// Translations
	@override String title({required Object airport}) => 'Orte rund um ${airport}, die du nicht verpassen solltest';
	@override String get subtitle => 'Du fliegst jedes Mal direkt darüber hinweg — halte auf deinem nächsten Flug Ausschau:';
	@override String scanning({required Object airport}) => 'Wir scannen den Himmel rund um ${airport}…';
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'home.tabLearn' => 'Lernen',
			'home.tabMedia' => 'Medien',
			'home.openSkyCamera' => 'Sky Camera öffnen',
			...
			'skyCamera.loading' => 'Kamera wird geladen...',
			'skyCamera.loadingGpsData' => 'GPS-Daten werden geladen',
			'skyCamera.zoom' => 'Zoom',
			'skyCamera.flash' => 'Blitz',
			'skyCamera.cameraUnavailable' => 'Die Kamera ist gerade nicht verfügbar.',
			'skyCamera.cameraPermissionDenied' => 'Für Fotos und Videoaufnahmen wird Kamerazugriff benötigt.',
			'skyCamera.captureFailed' => 'Diese Aufnahme konnte gerade nicht gespeichert werden.',
			'skyCamera.savedMessage' => 'Foto gespeichert',
			'skyCamera.share' => 'Teilen',
			'skyCamera.noActiveFlightTitle' => 'Kein aktiver Flug',
			'skyCamera.noActiveFlightMessage' => 'Sky Camera funktioniert auch ohne Flug, aber Routendetails erscheinen nur während eines aktiven Flugs.',
			'skyCamera.telemetrySpeed' => 'Geschwindigkeit',
			'skyCamera.telemetryAltitude' => 'Höhe',
			'skyCamera.telemetryHeading' => 'Kurs',
			'skyCamera.telemetryTime' => 'Zeit',
			'skyCamera.contextCaption' => 'Kontext',
			'skyCamera.mapCaption' => 'Karte',
			'skyCamera.coordinatesCaption' => 'Koordinaten',
			...
			'skyCamera.placeholderContext' => 'Mittelmeer',
			'skyCamera.placeholderMap' => 'Routenvorschau',
			'skyCamera.settingsTitle' => 'Kameraeinstellungen',
			'skyCamera.recordAudio' => 'Ton aufnehmen',
			'skyCamera.recordAudioHint' => 'Videos nehmen Mikrofonton auf.',
			'skyCamera.microphonePermissionDenied' => 'Mikrofonzugriff ist aus — Videos werden ohne Ton aufgenommen.',
			'skyCamera.lowStorageRecordingBlocked' => 'Gib Speicherplatz frei, bevor du ein Video aufnimmst.',
			'skyCamera.lowStorageRecordingStopped' => 'Die Aufnahme wurde gestoppt und gespeichert, weil der Speicher fast voll ist.',
			'skyCamera.lowStorageVideoExport' => 'Gib Speicherplatz frei, bevor du dieses Video vorbereitest.',
			'skyCamera.hotDeviceRecordingBlocked' => 'Dein Gerät ist zu heiß für eine Aufnahme. Lass es abkühlen und versuche es erneut.',
			'skyCamera.hotDeviceRecordingStopped' => 'Die Aufnahme wurde gestoppt und gespeichert, weil dein Gerät zu heiß ist.',
			'skyCamera.preparingVideo' => 'Video wird vorbereitet…',
			'media.title' => 'Medien vom Fensterplatz',
			'media.loading' => 'Medien werden geladen...',
			'media.failedToLoad' => 'Medien konnten nicht geladen werden',
			'media.filesTab' => 'Dateien',
			'media.flightsTab' => 'Flüge',
			'media.emptyTitle' => 'Willkommen bei deiner Sky Camera am Fensterplatz',
			'media.emptySubtitle' => 'Halte wunderschöne Ausblicke von deinem Fensterplatz fest und teile sie mit Flug- und GPS-Daten-Overlays.',
			'media.emptyFlightsTitle' => 'Noch keine Flugordner',
			'media.emptyFlightsSubtitle' => 'Mit gespeicherten Flügen verknüpfte Aufnahmen erscheinen hier.',
			'media.deleteAction' => 'Löschen',
			'media.share' => 'Teilen',
			'media.selectedCount' => ({required Object count}) => '${count} ausgewählt',
			'media.groupNoFlight' => 'Kein Flugkontext',
			'media.groupNoFlightSubtitle' => 'Aufnahmen außerhalb eines aktiven Flugs',
			'media.groupUnknownFlight' => 'Flugaufnahme',
			'media.previewTitle' => 'Aufnahme',
			'media.captureCount' => ({required Object count}) => '${count} Aufnahmen',
			'media.deleteFolder' => 'Ordner löschen',
			'media.deleteFolders' => ({required Object count}) => '${count} Ordner löschen',
			'media.deleteFile' => 'Datei löschen',
			'media.deleteFiles' => ({required Object count}) => '${count} Dateien löschen',
			'media.deleteFolderConfirm' => ({required Object count}) => 'Diesen Ordner und alle ${count} Dateien löschen?',
			'media.deleteFoldersConfirm' => ({required Object count}) => '${count} Ordner und alle enthaltenen Dateien löschen?',
			'media.deleteFileConfirm' => 'Diese Datei löschen?',
			'media.deleteFilesConfirm' => ({required Object count}) => '${count} Dateien löschen?',
			...
			'learn.geoQuiz.geographyTitle' => 'Geografie',
			'learn.geoQuiz.geographySubtitle' => 'Meere, Gebirge, Seen, Inseln und mehr',
			...
			'learn.geoQuiz.countryHint' => 'Regionsname...',
			...
			'learn.geoQuiz.hintTitle' => 'Hinweis',
			'learn.geoQuiz.hintSubtitle' => 'Tippe auf einen Buchstaben, um ihn aufzudecken',
			...
			'learn.geoQuiz.quizCountriesAfricaTitle' => 'Afrika',
			'learn.geoQuiz.quizCountriesEuropeTitle' => 'Europa',
			'learn.geoQuiz.quizCountriesAsiaTitle' => 'Asien',
			'learn.geoQuiz.quizCountriesNorthAmericaTitle' => 'Nordamerika',
			'learn.geoQuiz.quizCountriesSouthAmericaTitle' => 'Südamerika',
			'learn.geoQuiz.quizCountriesOceaniaTitle' => 'Ozeanien',
			'learn.geoQuiz.quizCountriesAllTitle' => 'Alle Länder',
			'learn.geoQuiz.quizCountriesSubtitle' => 'Länder',
			'learn.geoQuiz.quizCountriesAllSubtitle' => 'Welt',
			'learn.geoQuiz.quizGeographySeasTitle' => 'Meere',
			'learn.geoQuiz.quizGeographyMountainRangesTitle' => 'Gebirge',
			'learn.geoQuiz.quizGeographyLakesTitle' => 'Seen',
			'learn.geoQuiz.quizGeographyIslandsTitle' => 'Inseln',
			'learn.geoQuiz.quizGeographyOtherTitle' => 'Weitere',
			'learn.geoQuiz.quizGeographyOtherSubtitle' => 'Buchten, Meerengen, Golfe, Wüsten und mehr',
			...
			'settings.historyRestoreFlight' => 'Flug wiederherstellen',
			'settings.historyRestoreSuccess' => 'Der Flug wurde als bevorstehend wiederhergestellt.',
			'settings.historyRestoreError' => 'Flug konnte nicht wiederhergestellt werden.',
			...
			'settings.notifications.summaryOn' => 'Ein',
			'settings.notifications.summaryOff' => 'Aus',
			...
			'settings.advocacyDialogTitle' => 'Schön, dass dir Flymap gefällt',
			'settings.advocacyDialogBody' => 'Hilf anderen Reisenden, Flymap zu entdecken.',
			'settings.advocacyDialogShare' => 'Mit Freunden teilen',
			'settings.advocacyDialogRate' => 'Flymap bewerten',
			'settings.advocacyDialogNotNow' => 'Nicht jetzt',
			...
			'createFlight.weather.continueWithoutWeather' => 'Ohne Wetter fortfahren',
			'createFlight.weather.noDateTitle' => 'Flugdatum & Uhrzeit hinzufügen',
			'createFlight.weather.noDatePickBody' => 'Für eine Wettervorhersage werden dein Flugdatum und deine Abflugzeit benötigt.',
			'createFlight.weather.noDatePickButton' => 'Datum & Uhrzeit wählen',
			'createFlight.weather.noDateRealBody' => 'Ohne dein Flugdatum ist keine Wettervorhersage möglich. Wähle ein Datum aus, wenn du diesen Flug auswählst, um das Wetter zu sehen.',
			'createFlight.weather.noDateBackButton' => 'Zurück, um ein Datum zu wählen',
			'createFlight.weather.forecastTooFarTitle' => 'Für eine zuverlässige Vorhersage ist es noch zu früh',
			'createFlight.weather.forecastTooFarBody' => ({required Object days}) => 'Wettervorhersagen sind nur bis zu ${days} Tage im Voraus verlässlich. Wir benachrichtigen dich vor deinem Flug, sobald eine zuverlässige Vorhersage verfügbar ist.',
			'createFlight.weather.pastForecastTitle' => 'Dieses Flugdatum ist bereits vorbei',
			'createFlight.weather.pastForecastBody' => 'Für vergangene Flüge sind keine Vorhersagen verfügbar.',
			'createFlight.weather.notificationPermissionHint' => 'Benachrichtigungen sind aus. Aktiviere sie, damit dich die Vorhersage-Erinnerung erreichen kann.',
			...
			'createFlight.weather.estimatedShort' => 'geschätzt',
			...
			'createFlight.weather.windWindy' => 'Windig',
			'createFlight.weather.windStrong' => 'Starker Wind',
			'createFlight.weather.proTeaserTitle' => 'Schalte Flughafenwetter und Wolken entlang deiner Route frei',
			'createFlight.weather.attribution' => ({required Object provider, required Object license}) => 'Basierend auf Daten von ${provider} · Visualisierung durch Flymap · ${license}',
			'createFlight.weather.attributionShare' => ({required Object provider, required Object license}) => 'Daten: ${provider} · Visualisierung: Flymap · ${license}',
			'createFlight.weather.hedge' => 'Vorhersagen werden näher am Abflug genauer.',
			'createFlight.weather.share' => 'Teilen',
			'createFlight.weather.shareAsImage' => 'Als Bild teilen',
			'createFlight.weather.shareAsVideo' => 'Als Video teilen',
			'createFlight.weather.preparingShare' => 'Teilen wird vorbereitet…',
			'createFlight.weather.shareFailed' => 'Teilen konnte nicht vorbereitet werden — versuche es erneut.',
			'createFlight.weather.updatedRelative' => ({required Object relative}) => 'Aktualisiert ${relative}',
			'createFlight.weather.updatedExact' => ({required Object date, required Object time}) => 'Aktualisiert ${date}, ${time}',
			'createFlight.weather.updatedJustNow' => 'gerade eben',
			'createFlight.weather.updatedMinutesAgo' => ({required Object minutes}) => 'vor ${minutes} Min.',
			'createFlight.weather.updatedHoursAgo' => ({required Object hours}) => 'vor ${hours} Std.',
			...
			'createFlight.travelDate.pickDate' => 'Reisedatum auswählen',
			'createFlight.travelDate.yourFlightOnDate' => 'Dein Flug an diesem Datum',
			'createFlight.travelDate.changeDate' => 'Datum ändern',
			'createFlight.travelDate.checkingSchedule' => 'Flugplan wird geprüft…',
			'createFlight.travelDate.noDateYet' => 'Noch kein Datum',
			'createFlight.travelDate.skipDate' => 'Ohne Datum fortfahren',
			'createFlight.travelDate.skipDateTimeScreen' => 'Datum & Uhrzeit überspringen',
			'createFlight.travelDate.addDepartureTime' => 'Abflugzeit hinzufügen',
			'createFlight.travelDate.departureTimeAt' => ({required Object time}) => 'Abflugzeit · ${time}',
			'createFlight.travelDate.departureTimeTitle' => 'Abflugzeit',
			'createFlight.travelDate.departureTimeHint' => 'Lege die lokale Abflugzeit fest, um fortzufahren.',
			'createFlight.travelDate.departureTimePickDateFirst' => 'Wähle zuerst ein Datum und lege dann die Abflugzeit fest.',
			'createFlight.travelDate.setDepartureTime' => 'Abflugzeit festlegen',
			'createFlight.travelDate.departureTimeSelected' => ({required Object time}) => 'Abflug · ${time}',
			'createFlight.travelDate.notificationPermissionTitle' => 'Flugerinnerungen erhalten',
			'createFlight.travelDate.notificationPermissionBody' => 'Erlaube Mitteilungen, damit Flymap dich daran erinnern kann, vor deinem Flug das aktuelle Wetter zu prüfen.',
			'createFlight.travelDate.notificationPermissionNotNow' => 'Nicht jetzt',
			'createFlight.travelDate.notificationPermissionAllow' => 'Mitteilungen erlauben',
			'createFlight.travelDate.noDepartureOnDateTitle' => 'Wir konnten diesen Flug an diesem Datum nicht finden',
			'createFlight.travelDate.noDepartureOnDateBody' => 'Prüfe das Datum oder lege die Abflugzeit manuell fest, um fortzufahren.',
			'createFlight.travelDate.dateCheckFailed' => 'Datum konnte nicht geprüft werden. Lege die Abflugzeit manuell fest, um fortzufahren.',
			...
			'createFlight.flightNumberSearch.editFlightNumber' => 'Flugnummer ändern',
			...
			'createFlight.realRouteAirportSearch.foundOneTitle' => ({required Object route}) => '1 Flug gefunden · ${route}',
			'createFlight.realRouteAirportSearch.foundManyTitle' => ({required Object count, required Object route}) => '${count} Flüge gefunden · ${route}',
			...
			'preview.openFlight' => 'Flug öffnen',
			...
			'flight.hub.timelineSubtitle' => ({required Object count}) => '${count} Regionen entlang deiner Route',
			'flight.hub.placesTitle' => 'Orte',
			'flight.hub.placesSubtitle' => ({required Object count}) => '${count} Orte aus deinem Fenster zu entdecken',
			'flight.hub.filterAll' => 'Alle',
			'flight.hub.noPlaces' => 'Keine Orte für diesen Flug gespeichert.',
			'flight.hub.weatherTitle' => 'Wetter',
			'flight.hub.weatherCheck' => 'Prüfe deine Vorhersage',
			'flight.hub.weatherTooEarly' => 'Noch zu früh für eine zuverlässige Vorhersage — wir benachrichtigen dich',
			'flight.hub.weatherLocked' => 'Wolkenkarte und Flughafenwetter — Pro',
			'flight.hub.articlesTitle' => 'Artikel',
			'flight.hub.articlesSubtitle' => ({required Object count}) => '${count} Artikel offline gespeichert',
			...
			'flight.dashboard.gpsEstimatedShort' => 'Geschätzt',
			'flight.dashboard.gpsLastKnownShort' => 'Letzte Pos.',
			'flight.dashboard.gpsLastTelemetryShort' => 'Zuletzt',
			...
			'flightVideo.avatarTitle' => 'Dein Avatar',
			'flightVideo.avatarHint' => 'Fliege deine Route mit deinem eigenen Foto',
			'flightVideo.avatarSetupTitle' => 'Dein Avatar',
			'flightVideo.avatarPick' => 'Foto wählen',
			'flightVideo.avatarChange' => 'Foto ändern',
			'flightVideo.avatarNameLabel' => 'Name oder @Handle',
			'flightVideo.avatarNameHint' => 'Optional – auf der Zusammenfassungskarte sichtbar',
			'flightVideo.avatarSave' => 'Avatar speichern',
			'flightVideo.mysteryTitle' => 'Rate, wohin ich fliege? ✈️',
			'flightVideo.avatarCardTagline' => 'Meine Flugkarte',
			...
			'notifications.forecastUpdatedTitle' => 'Dein Flug ist morgen',
			'notifications.forecastUpdatedBody' => ({required Object route}) => '${route} — öffne Flymap für die aktuelle Vorhersage.',
			...
			'notifications.reminderTomorrowBody' => ({required Object route}) => '${route} morgen — vergiss nicht, die App im Flug zu öffnen und alles zu entdecken, was du überfliegst.',
			...
			'onboarding.interestsTitle' => 'Welche Orte möchtest du häufiger auf deiner Karte sehen?',
			...
			'onboarding.payoff.title' => ({required Object airport}) => 'Orte rund um ${airport}, die du nicht verpassen solltest',
			'onboarding.payoff.subtitle' => 'Du fliegst jedes Mal direkt darüber hinweg — halte auf deinem nächsten Flug Ausschau:',
			'onboarding.payoff.scanning' => ({required Object airport}) => 'Wir scannen den Himmel rund um ${airport}…',
