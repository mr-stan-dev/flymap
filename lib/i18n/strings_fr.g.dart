...
class TranslationsFr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsSkyCameraFr skyCamera = _TranslationsSkyCameraFr._(_root);
	@override late final _TranslationsMediaFr media = _TranslationsMediaFr._(_root);
...
class _TranslationsHomeFr extends TranslationsHomeEn {
	...
	@override String get tabLearn => 'Apprendre';
	@override String get tabMedia => 'Médias';
	@override String get openSkyCamera => 'Ouvrir Sky Camera';
	...
	@override String regionsCount({required Object count}) => '${count} régions';
...
// Path: skyCamera
class _TranslationsSkyCameraFr extends TranslationsSkyCameraEn {
	_TranslationsSkyCameraFr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String get loading => 'Chargement de l’appareil photo...';
	@override String get loadingGpsData => 'Chargement des données GPS';
	...
	@override String get noActiveFlightMessage => 'Sky Camera fonctionne sans vol, mais les détails d’itinéraire n’apparaissent que pendant un vol actif.';
	@override String get telemetrySpeed => 'Vitesse';
	@override String get telemetryAltitude => 'Altitude';
	@override String get telemetryHeading => 'Cap';
	@override String get telemetryTime => 'Heure';
	@override String get contextCaption => 'Contexte';
	@override String get mapCaption => 'Carte';
	@override String get coordinatesCaption => 'Coordonnées';
...
// Path: media
class _TranslationsMediaFr extends TranslationsMediaEn {
	_TranslationsMediaFr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Médias côté hublot';
	@override String get loading => 'Chargement des médias...';
	@override String get failedToLoad => 'Impossible de charger les médias';
	@override String get filesTab => 'Fichiers';
	@override String get flightsTab => 'Vols';
	@override String get emptyTitle => 'Bienvenue dans votre Sky Camera côté hublot';
	@override String get emptySubtitle => 'Capturez et partagez de magnifiques vues depuis votre siège côté hublot avec des données de vol et GPS en surimpression.';
	@override String get emptyFlightsTitle => 'Aucun dossier de vol pour l’instant';
	@override String get emptyFlightsSubtitle => 'Les captures liées aux vols enregistrés apparaîtront ici.';
	@override String get deleteAction => 'Supprimer';
	@override String get share => 'Partager';
	@override String selectedCount({required Object count}) => '${count} sélectionné(s)';
	@override String get groupNoFlight => 'Aucun contexte de vol';
	@override String get groupNoFlightSubtitle => 'Captures prises hors d’un vol actif';
	@override String get groupUnknownFlight => 'Capture de vol';
	@override String get previewTitle => 'Capture';
	@override String captureCount({required Object count}) => '${count} captures';
	@override String get deleteFolder => 'Supprimer le dossier';
	@override String deleteFolders({required Object count}) => 'Supprimer ${count} dossiers';
	@override String get deleteFile => 'Supprimer le fichier';
	@override String deleteFiles({required Object count}) => 'Supprimer ${count} fichiers';
	@override String deleteFolderConfirm({required Object count}) => 'Supprimer ce dossier et ses ${count} fichiers ?';
	@override String deleteFoldersConfirm({required Object count}) => 'Supprimer ${count} dossiers et tous les fichiers qu’ils contiennent ?';
	@override String get deleteFileConfirm => 'Supprimer ce fichier ?';
	@override String deleteFilesConfirm({required Object count}) => 'Supprimer ${count} fichiers ?';
}
...
class _TranslationsLearnFr extends TranslationsLearnEn {
	...
	@override String get quizzesTitle => 'Quiz';
	@override String get articlesTitle => 'Articles';
	@override late final _TranslationsLearnGeoQuizFr geoQuiz = _TranslationsLearnGeoQuizFr._(_root);
}
...
class _TranslationsSettingsFr extends TranslationsSettingsEn {
	...
	@override String get proBannerSubtitleActive => 'Itinéraires réels, cartes hors ligne, météo, lieux et récits débloqués.';
	@override String get proBannerSubtitleFree => 'Débloquez les itinéraires réels, cartes hors ligne, météo, lieux et récits';
...
class _TranslationsSubscriptionFr extends TranslationsSubscriptionEn {
	...
	@override String get weeklyPlan => 'Abonnement hebdomadaire';
	@override String get monthlyPlan => 'Abonnement mensuel';
	@override String get yearlyPlan => 'Abonnement annuel';
	@override String planEnds({required Object date}) => 'Se termine le ${date}';
	...
	@override String get proFeatureMapsBody => 'Gardez des cartes enrichies accessibles en vol sans Internet.';
	@override String get proFeatureTimelineTitle => 'Timeline complète et 10 fois plus de lieux';
	@override String get proFeatureTimelineBody => 'Découvrez chaque région et davantage de points d’intérêt sur votre trajet.';
	@override String get proFeatureWeatherTitle => 'Couverture nuageuse et météo des aéroports';
	@override String get proFeatureWeatherBody => 'Sachez ce que vous pourrez voir avant le décollage.';
	...
	@override String get proFeatureLearnTitle => 'Accès complet à Learn et Geo Quiz';
	@override String get proFeatureLearnBody => 'Explorez tous les récits et défis de géographie.';
	@override String get planAndBillingTitle => 'Offre et facturation';
	@override String get planLabel => 'Offre';
	@override String get activeSubscription => 'Abonnement actif';
	@override String currentPeriodEnds({required Object date}) => 'La période en cours se termine le ${date}';
	@override String get managePlanAndBilling => 'Gérer l’offre et la facturation';
	@override String get cancelSubscription => 'Annuler l’abonnement';
	@override String get flightPassesTitle => 'Pass de vol';
	@override String get flightPassesBody => 'Ces déblocages pour un vol resteront disponibles pour vos prochains vols.';
	@override String get purchaseHelpTitle => 'Aide concernant les achats';
...
class _TranslationsPreviewFr extends TranslationsPreviewEn {
	...
	@override String get openFlight => 'Ouvrir le vol';
	@override String get shareFlightCard => 'Mettez votre superbe vol en avant';
	@override String get shareVideo => 'Partager la vidéo du vol';
...
// Path: flightVideo
class _TranslationsFlightVideoFr extends TranslationsFlightVideoEn {
	_TranslationsFlightVideoFr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Vidéo du vol';
	@override String get preparing => 'Préparation de votre carte...';
	@override String get rendering => 'Création de votre vidéo...';
	@override String get export => 'Enregistrer la vidéo';
	@override String get savedToGallery => 'Enregistrée dans votre galerie';
	@override String get saveSkipped => 'Impossible d\'enregistrer dans la galerie — vous pouvez quand même la partager';
	@override String get share => 'Partager';
	@override String get sharing => 'Partage...';
	@override String get retry => 'Réessayer';
	...
	@override String get styleSatellite => 'Satellite';
	@override String get styleDefault => 'Par défaut';
	@override String get videoSettings => 'Réglages vidéo';
	@override String get mapStyle => 'Style de carte';
	@override String get mysteryDestination => 'Destination mystère';
	@override String get mysteryDestinationHint => 'Afficher « ? » jusqu\'à l\'atterrissage';
	@override String get showPins => 'Épingles de pays';
	@override String get showPinsHint => 'Place une épingle quand l\'avion traverse chaque pays';
	@override String get showEndCard => 'Carte récapitulative';
	@override String get showEndCardHint => 'Afficher la carte récapitulative à la fin';
...
class _TranslationsNotificationsFr extends TranslationsNotificationsEn {
	...
	@override String reminderTomorrowBody({required Object route}) => '${route} demain — n\'oubliez pas d\'ouvrir l\'app en vol et d\'explorer tout ce que vous survolez.';
}
...
class _TranslationsOnboardingFr extends TranslationsOnboardingEn {
	...
	@override String get interestsTitle => 'Quels lieux voulez-vous voir davantage sur votre carte ?';
	...
	@override late final _TranslationsOnboardingSocialProofFr socialProof = _TranslationsOnboardingSocialProofFr._(_root);
}
...
// Path: learn.geoQuiz
class _TranslationsLearnGeoQuizFr extends TranslationsLearnGeoQuizEn {
	_TranslationsLearnGeoQuizFr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Geo Quiz';
	@override String get geographyTitle => 'Géographie';
	@override String get geographySubtitle => 'Mers, chaînes de montagnes, lacs, îles et plus';
	@override String get countriesTitle => 'Pays sur la carte';
	@override String get subtitle => 'Devinez le pays d’après sa silhouette';
	@override String get loading => 'Chargement de Geo Quiz...';
	@override String get failedToLoad => 'Échec du chargement des quiz';
	@override String get failedToLoadQuiz => 'Échec du chargement du quiz';
	@override String get emptyTitle => 'Aucun quiz pour l’instant';
	@override String get emptySubtitle => 'Les geo quiz apparaîtront bientôt ici.';
	@override String get countryHint => 'Nom de la région...';
	@override String progressCount({required Object solved, required Object total}) => '${solved} / ${total}';
	@override String nextCount({required Object next, required Object total}) => '${next} sur ${total}';
	@override String correctCount({required Object count}) => '${count} corrects';
	@override String get reset => 'Réinitialiser la progression';
	@override String get mapPlaceholder => 'Les données de carte seront ajoutées ensuite';
	@override String get newBadge => 'NOUVEAU';
	@override String get correct => 'Correct';
	@override String get wrong => 'Incorrect';
	@override String get hintTitle => 'Indice';
	@override String get hintSubtitle => 'Touchez une lettre pour la révéler';
	@override String get next => 'Suivant';
	@override String get pause => 'Pause';
	@override String get resume => 'Reprendre';
	@override String get finish => 'Terminer';
	@override String get completeTitle => 'Quiz terminé';
	@override String completeMessage({required Object total, required Object quiz}) => 'Vous avez trouvé les ${total} pays de ${quiz}.';
	@override String get backToQuizzes => 'Retour aux quiz';
	@override String get playAgain => 'Rejouer';
	@override String get progressReady => 'Prêt à jouer';
	@override String progressFinished({required Object count}) => '${count} terminés';
	@override String progressInProgress({required Object count}) => '${count} en cours';
	@override String get progressAllCompleted => 'Tous terminés';
	@override String get quizCountriesAfricaTitle => 'Afrique';
	@override String get quizCountriesEuropeTitle => 'Europe';
	@override String get quizCountriesAsiaTitle => 'Asie';
	@override String get quizCountriesNorthAmericaTitle => 'Amérique du Nord';
	@override String get quizCountriesSouthAmericaTitle => 'Amérique du Sud';
	@override String get quizCountriesOceaniaTitle => 'Océanie';
	@override String get quizCountriesAllTitle => 'Tous les pays';
	@override String get quizCountriesSubtitle => 'Pays';
	@override String get quizCountriesAllSubtitle => 'Monde';
	@override String get quizGeographySeasTitle => 'Mers';
	@override String get quizGeographyMountainRangesTitle => 'Chaînes de montagnes';
	@override String get quizGeographyLakesTitle => 'Lacs';
	@override String get quizGeographyIslandsTitle => 'Îles';
...
class _TranslationsSettingsNotificationsFr extends TranslationsSettingsNotificationsEn {
	...
	@override String get permissionOff => 'Les notifications sont désactivées. Activez-les pour recevoir des rappels et des alertes de prévisions pour vos vols.';
	@override String get readyTitle => 'Rappel anticipé';
	@override String get readySubtitle => '6 jours avant le vol';
	@override String get updatedTitle => 'Rappel de la veille';
	@override String get updatedSubtitle => 'La veille du vol, en soirée';
	@override String get summaryOn => 'Activées';
	@override String get summaryOff => 'Désactivées';
}
...
class _TranslationsCreateFlightWeatherFr extends TranslationsCreateFlightWeatherEn {
	...
	@override String get cloudsLoading => 'Chargement des nuages…';
...
class _TranslationsCreateFlightTravelDateFr extends TranslationsCreateFlightTravelDateEn {
	_TranslationsCreateFlightTravelDateFr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String inDays({required Object count}) => 'Dans ${count} jours';
	...
	@override String get yourFlightOnDate => 'Votre vol à cette date';
	@override String get changeDate => 'Modifier la date';
...
class _TranslationsCreateFlightFlightNumberSearchFr extends TranslationsCreateFlightFlightNumberSearchEn {
	...
	@override String get loadingHint => 'Cela peut prendre quelques secondes pendant que nous vérifions les vols récents.';
	...
	@override String get editFlightNumber => 'Modifier le numéro de vol';
	@override String get beyondWindowHint => 'Vous volez plus tard ? Pour une carte de vol la plus récente et précise, nous recommandons de la télécharger dans les 7 jours précédant votre vol.';
...
class _TranslationsCreateFlightRealRouteAirportSearchFr extends TranslationsCreateFlightRealRouteAirportSearchEn {
	...
	@override String get searchReverse => 'Essayer le sens inverse';
	...
	@override String foundOneTitle({required Object route}) => '1 vol trouvé · ${route}';
	@override String foundManyTitle({required Object count, required Object route}) => '${count} vols trouvés · ${route}';
...
class _TranslationsCreateFlightOverviewFr extends TranslationsCreateFlightOverviewEn {
	...
	@override String get buildingHint => 'Sur les longs itinéraires, cela peut prendre quelques secondes…';
...
class _TranslationsFlightDashboardFr extends TranslationsFlightDashboardEn {
	...
	@override String get gpsEstimatedShort => 'Estimée';
	@override String get gpsLastKnownShort => 'Dernière pos.';
	@override String get gpsLastTelemetryShort => 'Dernier';
...
class _TranslationsOnboardingPayoffFr extends TranslationsOnboardingPayoffEn {
	_TranslationsOnboardingPayoffFr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String title({required Object airport}) => 'Les lieux autour de ${airport} à ne pas manquer';
	@override String get subtitle => 'Vous les survolez à chaque vol — ouvrez l\'œil la prochaine fois :';
	@override String scanning({required Object airport}) => 'Exploration du ciel autour de ${airport}…';
...
class _TranslationsOnboardingSocialProofFr extends TranslationsOnboardingSocialProofEn {
	_TranslationsOnboardingSocialProofFr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Vos vols ne seront plus jamais les mêmes.';
	@override String get flightCount => '10 000+';
	@override String get flightCountCaption => 'vols explorés avec Flymap';
	@override String get testimonialsTitle => 'Plébiscité par les voyageurs curieux';
	@override String ratingLabel({required Object rating}) => '${rating} étoiles sur 5';
	@override String get testimonial1Quote => 'J’ai beaucoup aimé. J’ai appris beaucoup de choses sur la géographie pendant mon vol vers Londres.';
...
extension on TranslationsFr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'home.tabLearn' => 'Apprendre',
			'home.tabMedia' => 'Médias',
			'home.openSkyCamera' => 'Ouvrir Sky Camera',
			...
			'home.regionsCount' => ({required Object count}) => '${count} régions',
			...
			'skyCamera.loading' => 'Chargement de l’appareil photo...',
			'skyCamera.loadingGpsData' => 'Chargement des données GPS',
			'skyCamera.zoom' => 'Zoom',
			...
			'skyCamera.noActiveFlightMessage' => 'Sky Camera fonctionne sans vol, mais les détails d’itinéraire n’apparaissent que pendant un vol actif.',
			'skyCamera.telemetrySpeed' => 'Vitesse',
			'skyCamera.telemetryAltitude' => 'Altitude',
			'skyCamera.telemetryHeading' => 'Cap',
			'skyCamera.telemetryTime' => 'Heure',
			'skyCamera.contextCaption' => 'Contexte',
			'skyCamera.mapCaption' => 'Carte',
			'skyCamera.coordinatesCaption' => 'Coordonnées',
			...
			'media.filesTab' => 'Fichiers',
			'media.flightsTab' => 'Vols',
			'media.emptyTitle' => 'Bienvenue dans votre Sky Camera côté hublot',
			'media.emptySubtitle' => 'Capturez et partagez de magnifiques vues depuis votre siège côté hublot avec des données de vol et GPS en surimpression.',
			'media.emptyFlightsTitle' => 'Aucun dossier de vol pour l’instant',
			'media.emptyFlightsSubtitle' => 'Les captures liées aux vols enregistrés apparaîtront ici.',
			'media.deleteAction' => 'Supprimer',
			'media.share' => 'Partager',
			'media.selectedCount' => ({required Object count}) => '${count} sélectionné(s)',
			'media.groupNoFlight' => 'Aucun contexte de vol',
			'media.groupNoFlightSubtitle' => 'Captures prises hors d’un vol actif',
			'media.groupUnknownFlight' => 'Capture de vol',
			'media.previewTitle' => 'Capture',
			'media.captureCount' => ({required Object count}) => '${count} captures',
			'media.deleteFolder' => 'Supprimer le dossier',
			'media.deleteFolders' => ({required Object count}) => 'Supprimer ${count} dossiers',
			'media.deleteFile' => 'Supprimer le fichier',
			'media.deleteFiles' => ({required Object count}) => 'Supprimer ${count} fichiers',
			'media.deleteFolderConfirm' => ({required Object count}) => 'Supprimer ce dossier et ses ${count} fichiers ?',
			'media.deleteFoldersConfirm' => ({required Object count}) => 'Supprimer ${count} dossiers et tous les fichiers qu’ils contiennent ?',
			'media.deleteFileConfirm' => 'Supprimer ce fichier ?',
			'media.deleteFilesConfirm' => ({required Object count}) => 'Supprimer ${count} fichiers ?',
			...
			'learn.quizzesTitle' => 'Quiz',
			'learn.articlesTitle' => 'Articles',
			'learn.geoQuiz.title' => 'Geo Quiz',
			'learn.geoQuiz.geographyTitle' => 'Géographie',
			'learn.geoQuiz.geographySubtitle' => 'Mers, chaînes de montagnes, lacs, îles et plus',
			'learn.geoQuiz.countriesTitle' => 'Pays sur la carte',
			'learn.geoQuiz.subtitle' => 'Devinez le pays d’après sa silhouette',
			'learn.geoQuiz.loading' => 'Chargement de Geo Quiz...',
			'learn.geoQuiz.failedToLoad' => 'Échec du chargement des quiz',
			'learn.geoQuiz.failedToLoadQuiz' => 'Échec du chargement du quiz',
			'learn.geoQuiz.emptyTitle' => 'Aucun quiz pour l’instant',
			'learn.geoQuiz.emptySubtitle' => 'Les geo quiz apparaîtront bientôt ici.',
			'learn.geoQuiz.countryHint' => 'Nom de la région...',
			'learn.geoQuiz.progressCount' => ({required Object solved, required Object total}) => '${solved} / ${total}',
			'learn.geoQuiz.nextCount' => ({required Object next, required Object total}) => '${next} sur ${total}',
			'learn.geoQuiz.correctCount' => ({required Object count}) => '${count} corrects',
			'learn.geoQuiz.reset' => 'Réinitialiser la progression',
			'learn.geoQuiz.mapPlaceholder' => 'Les données de carte seront ajoutées ensuite',
			'learn.geoQuiz.newBadge' => 'NOUVEAU',
			'learn.geoQuiz.correct' => 'Correct',
			'learn.geoQuiz.wrong' => 'Incorrect',
			'learn.geoQuiz.hintTitle' => 'Indice',
			'learn.geoQuiz.hintSubtitle' => 'Touchez une lettre pour la révéler',
			'learn.geoQuiz.next' => 'Suivant',
			'learn.geoQuiz.pause' => 'Pause',
			'learn.geoQuiz.resume' => 'Reprendre',
			'learn.geoQuiz.finish' => 'Terminer',
			'learn.geoQuiz.completeTitle' => 'Quiz terminé',
			'learn.geoQuiz.completeMessage' => ({required Object total, required Object quiz}) => 'Vous avez trouvé les ${total} pays de ${quiz}.',
			'learn.geoQuiz.backToQuizzes' => 'Retour aux quiz',
			'learn.geoQuiz.playAgain' => 'Rejouer',
			'learn.geoQuiz.progressReady' => 'Prêt à jouer',
			'learn.geoQuiz.progressFinished' => ({required Object count}) => '${count} terminés',
			'learn.geoQuiz.progressInProgress' => ({required Object count}) => '${count} en cours',
			'learn.geoQuiz.progressAllCompleted' => 'Tous terminés',
			'learn.geoQuiz.quizCountriesAfricaTitle' => 'Afrique',
			'learn.geoQuiz.quizCountriesEuropeTitle' => 'Europe',
			'learn.geoQuiz.quizCountriesAsiaTitle' => 'Asie',
			'learn.geoQuiz.quizCountriesNorthAmericaTitle' => 'Amérique du Nord',
			'learn.geoQuiz.quizCountriesSouthAmericaTitle' => 'Amérique du Sud',
			'learn.geoQuiz.quizCountriesOceaniaTitle' => 'Océanie',
			'learn.geoQuiz.quizCountriesAllTitle' => 'Tous les pays',
			'learn.geoQuiz.quizCountriesSubtitle' => 'Pays',
			'learn.geoQuiz.quizCountriesAllSubtitle' => 'Monde',
			'learn.geoQuiz.quizGeographySeasTitle' => 'Mers',
			'learn.geoQuiz.quizGeographyMountainRangesTitle' => 'Chaînes de montagnes',
			'learn.geoQuiz.quizGeographyLakesTitle' => 'Lacs',
			'learn.geoQuiz.quizGeographyIslandsTitle' => 'Îles',
			'learn.geoQuiz.quizGeographyOtherTitle' => 'Autres',
			'learn.geoQuiz.quizGeographyOtherSubtitle' => 'Baies, détroits, golfes, déserts et plus',
			'learn.geoQuiz.descriptionUnavailable' => 'La description n’est pas encore disponible.',
			...
			'settings.notifications.permissionOff' => 'Les notifications sont désactivées. Activez-les pour recevoir des rappels et des alertes de prévisions pour vos vols.',
			'settings.notifications.readyTitle' => 'Rappel anticipé',
			'settings.notifications.readySubtitle' => '6 jours avant le vol',
			'settings.notifications.updatedTitle' => 'Rappel de la veille',
			'settings.notifications.updatedSubtitle' => 'La veille du vol, en soirée',
			'settings.notifications.summaryOn' => 'Activées',
			'settings.notifications.summaryOff' => 'Désactivées',
			...
			'settings.proBannerSubtitleActive' => 'Itinéraires réels, cartes hors ligne, météo, lieux et récits débloqués.',
			'settings.proBannerSubtitleFree' => 'Débloquez les itinéraires réels, cartes hors ligne, météo, lieux et récits',
			...
			'subscription.weeklyPlan' => 'Abonnement hebdomadaire',
			'subscription.monthlyPlan' => 'Abonnement mensuel',
			'subscription.yearlyPlan' => 'Abonnement annuel',
			'subscription.planEnds' => ({required Object date}) => 'Se termine le ${date}',
			...
			'subscription.proFeatureMapsBody' => 'Gardez des cartes enrichies accessibles en vol sans Internet.',
			'subscription.proFeatureTimelineTitle' => 'Timeline complète et 10 fois plus de lieux',
			'subscription.proFeatureTimelineBody' => 'Découvrez chaque région et davantage de points d’intérêt sur votre trajet.',
			'subscription.proFeatureWeatherTitle' => 'Couverture nuageuse et météo des aéroports',
			'subscription.proFeatureWeatherBody' => 'Sachez ce que vous pourrez voir avant le décollage.',
			...
			'subscription.proFeatureLearnTitle' => 'Accès complet à Learn et Geo Quiz',
			'subscription.proFeatureLearnBody' => 'Explorez tous les récits et défis de géographie.',
			'subscription.planAndBillingTitle' => 'Offre et facturation',
			'subscription.planLabel' => 'Offre',
			'subscription.activeSubscription' => 'Abonnement actif',
			'subscription.currentPeriodEnds' => ({required Object date}) => 'La période en cours se termine le ${date}',
			'subscription.managePlanAndBilling' => 'Gérer l’offre et la facturation',
			'subscription.cancelSubscription' => 'Annuler l’abonnement',
			'subscription.flightPassesTitle' => 'Pass de vol',
			'subscription.flightPassesBody' => 'Ces déblocages pour un vol resteront disponibles pour vos prochains vols.',
			'subscription.purchaseHelpTitle' => 'Aide concernant les achats',
			...
			'createFlight.weather.cloudsLoading' => 'Chargement des nuages…',
			...
			'createFlight.travelDate.inDays' => ({required Object count}) => 'Dans ${count} jours',
			'createFlight.travelDate.today' => 'Aujourd\'hui',
			...
			'createFlight.travelDate.yourFlightOnDate' => 'Votre vol à cette date',
			'createFlight.travelDate.changeDate' => 'Modifier la date',
			...
			'createFlight.flightNumberSearch.loadingHint' => 'Cela peut prendre quelques secondes pendant que nous vérifions les vols récents.',
			...
			'createFlight.flightNumberSearch.editFlightNumber' => 'Modifier le numéro de vol',
			'createFlight.flightNumberSearch.beyondWindowHint' => 'Vous volez plus tard ? Pour une carte de vol la plus récente et précise, nous recommandons de la télécharger dans les 7 jours précédant votre vol.',
			...
			'createFlight.realRouteAirportSearch.searchReverse' => 'Essayer le sens inverse',
			...
			'createFlight.realRouteAirportSearch.foundOneTitle' => ({required Object route}) => '1 vol trouvé · ${route}',
			'createFlight.realRouteAirportSearch.foundManyTitle' => ({required Object count, required Object route}) => '${count} vols trouvés · ${route}',
			...
			'createFlight.overview.buildingHint' => 'Sur les longs itinéraires, cela peut prendre quelques secondes…',
			...
			'preview.openFlight' => 'Ouvrir le vol',
			'preview.shareFlightCard' => 'Mettez votre superbe vol en avant',
			'preview.shareVideo' => 'Partager la vidéo du vol',
			...
			'flight.dashboard.gpsEstimatedShort' => 'Estimée',
			'flight.dashboard.gpsLastKnownShort' => 'Dernière pos.',
			'flight.dashboard.gpsLastTelemetryShort' => 'Dernier',
			...
			'flightVideo.title' => 'Vidéo du vol',
			'flightVideo.preparing' => 'Préparation de votre carte...',
			'flightVideo.rendering' => 'Création de votre vidéo...',
			'flightVideo.export' => 'Enregistrer la vidéo',
			'flightVideo.savedToGallery' => 'Enregistrée dans votre galerie',
			'flightVideo.saveSkipped' => 'Impossible d\'enregistrer dans la galerie — vous pouvez quand même la partager',
			'flightVideo.share' => 'Partager',
			'flightVideo.sharing' => 'Partage...',
			...
			'flightVideo.styleDefault' => 'Par défaut',
			'flightVideo.videoSettings' => 'Réglages vidéo',
			'flightVideo.mapStyle' => 'Style de carte',
			'flightVideo.mysteryDestination' => 'Destination mystère',
			'flightVideo.mysteryDestinationHint' => 'Afficher « ? » jusqu\'à l\'atterrissage',
			'flightVideo.showPins' => 'Épingles de pays',
			'flightVideo.showPinsHint' => 'Place une épingle quand l\'avion traverse chaque pays',
			'flightVideo.showEndCard' => 'Carte récapitulative',
			'flightVideo.showEndCardHint' => 'Afficher la carte récapitulative à la fin',
			...
			'notifications.reminderTomorrowBody' => ({required Object route}) => '${route} demain — n\'oubliez pas d\'ouvrir l\'app en vol et d\'explorer tout ce que vous survolez.',
			...
			'onboarding.interestsTitle' => 'Quels lieux voulez-vous voir davantage sur votre carte ?',
			...
			'onboarding.payoff.title' => ({required Object airport}) => 'Les lieux autour de ${airport} à ne pas manquer',
			'onboarding.payoff.subtitle' => 'Vous les survolez à chaque vol — ouvrez l\'œil la prochaine fois :',
			'onboarding.payoff.scanning' => ({required Object airport}) => 'Exploration du ciel autour de ${airport}…',
			...
			'onboarding.socialProof.title' => 'Vos vols ne seront plus jamais les mêmes.',
			'onboarding.socialProof.flightCount' => '10 000+',
			'onboarding.socialProof.flightCountCaption' => 'vols explorés avec Flymap',
			'onboarding.socialProof.testimonialsTitle' => 'Plébiscité par les voyageurs curieux',
			'onboarding.socialProof.ratingLabel' => ({required Object rating}) => '${rating} étoiles sur 5',
			'onboarding.socialProof.testimonial1Quote' => 'J’ai beaucoup aimé. J’ai appris beaucoup de choses sur la géographie pendant mon vol vers Londres.',
